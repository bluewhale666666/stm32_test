...
#define ST_IN17_I2_0      GPIO_ReadInputDataBit(GPIOG,GPIO_Pin_6)	 	
#define ST_IN18_I2_1      GPIO_ReadInputDataBit(GPIOG,GPIO_Pin_7)	 	
#define ST_IN19_I2_2      GPIO_ReadInputDataBit(GPIOG,GPIO_Pin_8)    
#define ST_IN20_I2_3      GPIO_ReadInputDataBit(GPIOC,GPIO_Pin_8)	 

#define ST_IN24_I3_0      GPIO_ReadInputDataBit(GPIOD,GPIO_Pin_15)	
#define ST_IN23_I3_1      GPIO_ReadInputDataBit(GPIOG,GPIO_Pin_2)	
#define ST_IN22_I3_2      GPIO_ReadInputDataBit(GPIOG,GPIO_Pin_3)	
#define ST_IN21_I3_3      GPIO_ReadInputDataBit(GPIOG,GPIO_Pin_5)	
