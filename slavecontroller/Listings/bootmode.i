...
#line 31 "etherCAT\\bootmode.h"
    ...
    void BL_Start( unsigned char State);
   void BL_Stop(void);
    void BL_StartDownload(unsigned int password);
   unsigned short BL_Data(unsigned short *pData,unsigned short Size);


 
#line 35 "etherCAT\\bootmode.c"
