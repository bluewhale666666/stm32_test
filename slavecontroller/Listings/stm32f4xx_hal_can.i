...
#line 214 "D:\\Keil_v5\\ARM\\PACK\\Keil\\STM32F4xx_DFP\\2.16.0\\Drivers\\STM32F4xx_HAL_Driver\\Src\\stm32f4xx_hal_can.c"
...
#line 326 "D:\\Keil_v5\\ARM\\PACK\\Keil\\STM32F4xx_DFP\\2.16.0\\Drivers\\STM32F4xx_HAL_Driver\\Src\\stm32f4xx_hal_can.c"
  ...
  ((hcan->Instance ->BTR) = ((uint32_t)(hcan->Init . Mode | hcan->Init . SyncJumpWidth | hcan->Init . TimeSeg1 | hcan->Init . TimeSeg2 | (hcan->Init . Prescaler - 1U))));
...
#line 483 "D:\\Keil_v5\\ARM\\PACK\\Keil\\STM32F4xx_DFP\\2.16.0\\Drivers\\STM32F4xx_HAL_Driver\\Src\\stm32f4xx_hal_can.c"
   
  HAL_CAN_MspDeInit(hcan);


   
  ((hcan->Instance ->MCR) |= ((0x1UL << (15U))));
...
#line 810 "D:\\Keil_v5\\ARM\\PACK\\Keil\\STM32F4xx_DFP\\2.16.0\\Drivers\\STM32F4xx_HAL_Driver\\Src\\stm32f4xx_hal_can.c"
...
#line 877 "D:\\Keil_v5\\ARM\\PACK\\Keil\\STM32F4xx_DFP\\2.16.0\\Drivers\\STM32F4xx_HAL_Driver\\Src\\stm32f4xx_hal_can.c"
     
     
    can_ip = ((CAN_TypeDef *) (0x40000000UL + 0x6400UL));

     
    ((void)0U);
    ((void)0U);
#line 890 "D:\\Keil_v5\\ARM\\PACK\\Keil\\STM32F4xx_DFP\\2.16.0\\Drivers\\STM32F4xx_HAL_Driver\\Src\\stm32f4xx_hal_can.c"

     
    ((can_ip->FMR) |= ((0x1UL << (0U))));

#line 904 "D:\\Keil_v5\\ARM\\PACK\\Keil\\STM32F4xx_DFP\\2.16.0\\Drivers\\STM32F4xx_HAL_Driver\\Src\\stm32f4xx_hal_can.c"
     
    ((can_ip->FMR) &= ~((0x3FUL << (8U))));
    ((can_ip->FMR) |= (sFilterConfig->SlaveStartFilterBank << (8U)));
    ...
    if (sFilterConfig->FilterScale == (0x00000000U))
    {
    ...
    if (sFilterConfig->FilterScale == (0x00000001U))
    {
    ...
    if (sFilterConfig->FilterMode == (0x00000000U))
    {
       
      ((can_ip->FM1R) &= ~(filternbrbitpos));
    }
    else  
    {
    ...
    if (sFilterConfig->FilterFIFOAssignment == (0x00000000U))
    {
       
      ((can_ip->FFA1R) &= ~(filternbrbitpos));
    }
    else
    {
    ...
    if (sFilterConfig->FilterActivation == (0x00000001U))
    {
      ((can_ip->FA1R) |= (filternbrbitpos));
    }
...
uint32_t HAL_CAN_IsSleepActive(CAN_HandleTypeDef *hcan)
{
      ...
      (state == HAL_CAN_STATE_LISTENING))
  {
    ...
    if ((hcan->Instance->MSR & (0x1UL << (1U))) != 0U)
    {
      status = 1U;
    }
  }
      ...
      (state == HAL_CAN_STATE_LISTENING))
  {
        ...
        ((tsr & (0x1UL << (28U))) != 0U))
    {
      ...
      *pTxMailbox = (uint32_t)1 << transmitmailbox;
      ...
      if (pHeader->IDE == (0x00000000U))
      {
        hcan->Instance->sTxMailBox[transmitmailbox].TIR = ((pHeader->StdId << (21U)) |
                                                           pHeader->RTR);
      }
      else
      {
        hcan->Instance->sTxMailBox[transmitmailbox].TIR = ((pHeader->ExtId << (3U)) |
                                                           pHeader->IDE |
                                                           pHeader->RTR);
      }
      ...
      {
        ((hcan->Instance ->sTxMailBox[transmitmailbox]. TDTR) |= ((0x1UL << (8U))));
      }

       
      ((hcan->Instance ->sTxMailBox[transmitmailbox]. TDHR) = (((uint32_t)aData[7] << (24U)) | ((uint32_t)aData[6] << (16U)) | ((uint32_t)aData[5] << (8U)) | ((uint32_t)aData[4] << (0U))));




      ((hcan->Instance ->sTxMailBox[transmitmailbox]. TDLR) = (((uint32_t)aData[3] << (24U)) | ((uint32_t)aData[2] << (16U)) | ((uint32_t)aData[1] << (8U)) | ((uint32_t)aData[0] << (0U))));
      ...
      ((hcan->Instance ->sTxMailBox[transmitmailbox]. TIR) |= ((0x1UL << (0U))));
...
HAL_StatusTypeDef HAL_CAN_AbortTxRequest(CAN_HandleTypeDef *hcan, uint32_t TxMailboxes)
{
      ...
      (state == HAL_CAN_STATE_LISTENING))
  {
    ...
    if ((TxMailboxes & (0x00000001U)) != 0U)
    {
       
      ((hcan->Instance ->TSR) |= ((0x1UL << (7U))));
    }

     
    if ((TxMailboxes & (0x00000002U)) != 0U)
    {
       
      ((hcan->Instance ->TSR) |= ((0x1UL << (15U))));
    }

     
    if ((TxMailboxes & (0x00000004U)) != 0U)
    {
       
      ((hcan->Instance ->TSR) |= ((0x1UL << (23U))));
    }
...
uint32_t HAL_CAN_GetTxMailboxesFreeLevel(CAN_HandleTypeDef *hcan)
{
      ...
      (state == HAL_CAN_STATE_LISTENING))
  {
    ...
    if ((hcan->Instance->TSR & (0x1UL << (26U))) != 0U)
    {
      freelevel++;
    }

     
    if ((hcan->Instance->TSR & (0x1UL << (27U))) != 0U)
    {
      freelevel++;
    }

     
    if ((hcan->Instance->TSR & (0x1UL << (28U))) != 0U)
    {
      freelevel++;
    }
  }
...
uint32_t HAL_CAN_IsTxMessagePending(CAN_HandleTypeDef *hcan, uint32_t TxMailboxes)
{
      ...
      (state == HAL_CAN_STATE_LISTENING))
  {
    ...
    if ((hcan->Instance->TSR & (TxMailboxes << (26U))) != (TxMailboxes << (26U)))
    {
      status = 1U;
    }
  }
...
uint32_t HAL_CAN_GetTxTimestamp(CAN_HandleTypeDef *hcan, uint32_t TxMailbox)
{
      ...
      (state == HAL_CAN_STATE_LISTENING))
  {
    ...
    transmitmailbox = (__clz(__rbit(TxMailbox)));

     
    timestamp = (hcan->Instance->sTxMailBox[transmitmailbox].TDTR & (0xFFFFUL << (16U))) >> (16U);
  }
...
HAL_StatusTypeDef HAL_CAN_GetRxMessage(CAN_HandleTypeDef *hcan, uint32_t RxFifo, CAN_RxHeaderTypeDef *pHeader, uint8_t aData[])
{
      ...
      (state == HAL_CAN_STATE_LISTENING))
  {
    ...
    if (RxFifo == (0x00000000U))  
    {
       
      if ((hcan->Instance->RF0R & (0x3UL << (0U))) == 0U)
      {
    ...
    else  
    {
      ...
      if ((hcan->Instance->RF1R & (0x3UL << (0U))) == 0U)
      {
    ...
    pHeader->IDE = (0x1UL << (2U)) & hcan->Instance->sFIFOMailBox[RxFifo].RIR;
    if (pHeader->IDE == (0x00000000U))
    {
      pHeader->StdId = ((0x7FFUL << (21U)) & hcan->Instance->sFIFOMailBox[RxFifo].RIR) >> (21U);
    }
    else
    {
      pHeader->ExtId = (((0x3FFFFUL << (3U)) | (0x7FFUL << (21U))) & hcan->Instance->sFIFOMailBox[RxFifo].RIR) >> (3U);
    }
    pHeader->RTR = ((0x1UL << (1U)) & hcan->Instance->sFIFOMailBox[RxFifo].RIR);
    pHeader->DLC = ((0xFUL << (0U)) & hcan->Instance->sFIFOMailBox[RxFifo].RDTR) >> (0U);
    pHeader->FilterMatchIndex = ((0xFFUL << (8U)) & hcan->Instance->sFIFOMailBox[RxFifo].RDTR) >> (8U);
    pHeader->Timestamp = ((0xFFFFUL << (16U)) & hcan->Instance->sFIFOMailBox[RxFifo].RDTR) >> (16U);

     
    aData[0] = (uint8_t)(((0xFFUL << (0U)) & hcan->Instance->sFIFOMailBox[RxFifo].RDLR) >> (0U));
    aData[1] = (uint8_t)(((0xFFUL << (8U)) & hcan->Instance->sFIFOMailBox[RxFifo].RDLR) >> (8U));
    aData[2] = (uint8_t)(((0xFFUL << (16U)) & hcan->Instance->sFIFOMailBox[RxFifo].RDLR) >> (16U));
    aData[3] = (uint8_t)(((0xFFUL << (24U)) & hcan->Instance->sFIFOMailBox[RxFifo].RDLR) >> (24U));
    aData[4] = (uint8_t)(((0xFFUL << (0U)) & hcan->Instance->sFIFOMailBox[RxFifo].RDHR) >> (0U));
    aData[5] = (uint8_t)(((0xFFUL << (8U)) & hcan->Instance->sFIFOMailBox[RxFifo].RDHR) >> (8U));
    aData[6] = (uint8_t)(((0xFFUL << (16U)) & hcan->Instance->sFIFOMailBox[RxFifo].RDHR) >> (16U));
    aData[7] = (uint8_t)(((0xFFUL << (24U)) & hcan->Instance->sFIFOMailBox[RxFifo].RDHR) >> (24U));

     
    if (RxFifo == (0x00000000U))  
    {
       
      ((hcan->Instance ->RF0R) |= ((0x1UL << (5U))));
    }
    else  
    {
       
      ((hcan->Instance ->RF1R) |= ((0x1UL << (5U))));
    }
...
uint32_t HAL_CAN_GetRxFifoFillLevel(CAN_HandleTypeDef *hcan, uint32_t RxFifo)
{
      ...
      (state == HAL_CAN_STATE_LISTENING))
  {
    if (RxFifo == (0x00000000U))
    {
      filllevel = hcan->Instance->RF0R & (0x3UL << (0U));
    }
    else  
    {
      filllevel = hcan->Instance->RF1R & (0x3UL << (0U));
    }
  }
...
void HAL_CAN_IRQHandler(CAN_HandleTypeDef *hcan)
{
  ...
  uint32_t tsrflags = ((hcan->Instance ->TSR));
  uint32_t rf0rflags = ((hcan->Instance ->RF0R));
  uint32_t rf1rflags = ((hcan->Instance ->RF1R));
  uint32_t esrflags = ((hcan->Instance ->ESR));

   
  if ((interrupts & ((uint32_t)(0x1UL << (0U)))) != 0U)
  {
     
    if ((tsrflags & (0x1UL << (0U))) != 0U)
    {
       
      (((((0x00000500U)) >> 8U) == 5U)? (((hcan)->Instance ->TSR) = (1U << (((0x00000500U)) & (0x000000FFU)))): ((((0x00000500U)) >> 8U) == 2U)? (((hcan)->Instance ->RF0R) = (1U << (((0x00000500U)) & (0x000000FFU)))): ((((0x00000500U)) >> 8U) == 4U)? (((hcan)->Instance ->RF1R) = (1U << (((0x00000500U)) & (0x000000FFU)))): ((((0x00000500U)) >> 8U) == 1U)? (((hcan)->Instance ->MSR) = (1U << (((0x00000500U)) & (0x000000FFU)))): 0U);

      if ((tsrflags & (0x1UL << (1U))) != 0U)
      {
      ...
      {
        if ((tsrflags & (0x1UL << (2U))) != 0U)
        {
           
          errorcode |= (0x00000800U);
        }
        else if ((tsrflags & (0x1UL << (3U))) != 0U)
        {
           
          errorcode |= (0x00001000U);
        }
        else
        {
    ...
    if ((tsrflags & (0x1UL << (8U))) != 0U)
    {
       
      (((((0x00000508U)) >> 8U) == 5U)? (((hcan)->Instance ->TSR) = (1U << (((0x00000508U)) & (0x000000FFU)))): ((((0x00000508U)) >> 8U) == 2U)? (((hcan)->Instance ->RF0R) = (1U << (((0x00000508U)) & (0x000000FFU)))): ((((0x00000508U)) >> 8U) == 4U)? (((hcan)->Instance ->RF1R) = (1U << (((0x00000508U)) & (0x000000FFU)))): ((((0x00000508U)) >> 8U) == 1U)? (((hcan)->Instance ->MSR) = (1U << (((0x00000508U)) & (0x000000FFU)))): 0U);

      if ((tsrflags & (0x1UL << (9U))) != 0U)
      {
      ...
      {
        if ((tsrflags & (0x1UL << (10U))) != 0U)
        {
           
          errorcode |= (0x00002000U);
        }
        else if ((tsrflags & (0x1UL << (11U))) != 0U)
        {
           
          errorcode |= (0x00004000U);
        }
        else
        {
    ...
    if ((tsrflags & (0x1UL << (16U))) != 0U)
    {
       
      (((((0x00000510U)) >> 8U) == 5U)? (((hcan)->Instance ->TSR) = (1U << (((0x00000510U)) & (0x000000FFU)))): ((((0x00000510U)) >> 8U) == 2U)? (((hcan)->Instance ->RF0R) = (1U << (((0x00000510U)) & (0x000000FFU)))): ((((0x00000510U)) >> 8U) == 4U)? (((hcan)->Instance ->RF1R) = (1U << (((0x00000510U)) & (0x000000FFU)))): ((((0x00000510U)) >> 8U) == 1U)? (((hcan)->Instance ->MSR) = (1U << (((0x00000510U)) & (0x000000FFU)))): 0U);

      if ((tsrflags & (0x1UL << (17U))) != 0U)
      {
      ...
      {
        if ((tsrflags & (0x1UL << (18U))) != 0U)
        {
           
          errorcode |= (0x00008000U);
        }
        else if ((tsrflags & (0x1UL << (19U))) != 0U)
        {
           
          errorcode |= (0x00010000U);
        }
        else
        {
  ...
  if ((interrupts & ((uint32_t)(0x1UL << (3U)))) != 0U)
  {
    if ((rf0rflags & (0x1UL << (4U))) != 0U)
    {
       
      errorcode |= (0x00000200U);

       
      (((((0x00000204U)) >> 8U) == 5U)? (((hcan)->Instance ->TSR) = (1U << (((0x00000204U)) & (0x000000FFU)))): ((((0x00000204U)) >> 8U) == 2U)? (((hcan)->Instance ->RF0R) = (1U << (((0x00000204U)) & (0x000000FFU)))): ((((0x00000204U)) >> 8U) == 4U)? (((hcan)->Instance ->RF1R) = (1U << (((0x00000204U)) & (0x000000FFU)))): ((((0x00000204U)) >> 8U) == 1U)? (((hcan)->Instance ->MSR) = (1U << (((0x00000204U)) & (0x000000FFU)))): 0U);
    }
  }

   
  if ((interrupts & ((uint32_t)(0x1UL << (2U)))) != 0U)
  {
    if ((rf0rflags & (0x1UL << (3U))) != 0U)
    {
       
      (((((0x00000203U)) >> 8U) == 5U)? (((hcan)->Instance ->TSR) = (1U << (((0x00000203U)) & (0x000000FFU)))): ((((0x00000203U)) >> 8U) == 2U)? (((hcan)->Instance ->RF0R) = (1U << (((0x00000203U)) & (0x000000FFU)))): ((((0x00000203U)) >> 8U) == 4U)? (((hcan)->Instance ->RF1R) = (1U << (((0x00000203U)) & (0x000000FFU)))): ((((0x00000203U)) >> 8U) == 1U)? (((hcan)->Instance ->MSR) = (1U << (((0x00000203U)) & (0x000000FFU)))): 0U);
  ...
  if ((interrupts & ((uint32_t)(0x1UL << (1U)))) != 0U)
  {
  ...
  if ((interrupts & ((uint32_t)(0x1UL << (6U)))) != 0U)
  {
    if ((rf1rflags & (0x1UL << (4U))) != 0U)
    {
       
      errorcode |= (0x00000400U);

       
      (((((0x00000404U)) >> 8U) == 5U)? (((hcan)->Instance ->TSR) = (1U << (((0x00000404U)) & (0x000000FFU)))): ((((0x00000404U)) >> 8U) == 2U)? (((hcan)->Instance ->RF0R) = (1U << (((0x00000404U)) & (0x000000FFU)))): ((((0x00000404U)) >> 8U) == 4U)? (((hcan)->Instance ->RF1R) = (1U << (((0x00000404U)) & (0x000000FFU)))): ((((0x00000404U)) >> 8U) == 1U)? (((hcan)->Instance ->MSR) = (1U << (((0x00000404U)) & (0x000000FFU)))): 0U);
    }
  }

   
  if ((interrupts & ((uint32_t)(0x1UL << (5U)))) != 0U)
  {
    if ((rf1rflags & (0x1UL << (3U))) != 0U)
    {
       
      (((((0x00000403U)) >> 8U) == 5U)? (((hcan)->Instance ->TSR) = (1U << (((0x00000403U)) & (0x000000FFU)))): ((((0x00000403U)) >> 8U) == 2U)? (((hcan)->Instance ->RF0R) = (1U << (((0x00000403U)) & (0x000000FFU)))): ((((0x00000403U)) >> 8U) == 4U)? (((hcan)->Instance ->RF1R) = (1U << (((0x00000403U)) & (0x000000FFU)))): ((((0x00000403U)) >> 8U) == 1U)? (((hcan)->Instance ->MSR) = (1U << (((0x00000403U)) & (0x000000FFU)))): 0U);
  ...
  if ((interrupts & ((uint32_t)(0x1UL << (4U)))) != 0U)
  {
  ...
  if ((interrupts & ((uint32_t)(0x1UL << (17U)))) != 0U)
  {
    if ((msrflags & (0x1UL << (4U))) != 0U)
    {
       
      (((((0x00000104U)) >> 8U) == 5U)? (((hcan)->Instance ->TSR) = (1U << (((0x00000104U)) & (0x000000FFU)))): ((((0x00000104U)) >> 8U) == 2U)? (((hcan)->Instance ->RF0R) = (1U << (((0x00000104U)) & (0x000000FFU)))): ((((0x00000104U)) >> 8U) == 4U)? (((hcan)->Instance ->RF1R) = (1U << (((0x00000104U)) & (0x000000FFU)))): ((((0x00000104U)) >> 8U) == 1U)? (((hcan)->Instance ->MSR) = (1U << (((0x00000104U)) & (0x000000FFU)))): 0U);
  ...
  if ((interrupts & ((uint32_t)(0x1UL << (16U)))) != 0U)
  {
    if ((msrflags & (0x1UL << (3U))) != 0U)
    {
       
      (((((0x00000103U)) >> 8U) == 5U)? (((hcan)->Instance ->TSR) = (1U << (((0x00000103U)) & (0x000000FFU)))): ((((0x00000103U)) >> 8U) == 2U)? (((hcan)->Instance ->RF0R) = (1U << (((0x00000103U)) & (0x000000FFU)))): ((((0x00000103U)) >> 8U) == 4U)? (((hcan)->Instance ->RF1R) = (1U << (((0x00000103U)) & (0x000000FFU)))): ((((0x00000103U)) >> 8U) == 1U)? (((hcan)->Instance ->MSR) = (1U << (((0x00000103U)) & (0x000000FFU)))): 0U);
  ...
  if ((interrupts & ((uint32_t)(0x1UL << (15U)))) != 0U)
  {
    if ((msrflags & (0x1UL << (2U))) != 0U)
    {
       
      if (((interrupts & ((uint32_t)(0x1UL << (8U)))) != 0U) &&
          ((esrflags & (0x1UL << (0U))) != 0U))
      {
         
        errorcode |= (0x00000001U);

         
      }

       
      if (((interrupts & ((uint32_t)(0x1UL << (9U)))) != 0U) &&
          ((esrflags & (0x1UL << (1U))) != 0U))
      {
         
        errorcode |= (0x00000002U);

         
      }

       
      if (((interrupts & ((uint32_t)(0x1UL << (10U)))) != 0U) &&
          ((esrflags & (0x1UL << (2U))) != 0U))
      {
         
        errorcode |= (0x00000004U);

         
      }

       
      if (((interrupts & ((uint32_t)(0x1UL << (11U)))) != 0U) &&
          ((esrflags & (0x7UL << (4U))) != 0U))
      {
        switch (esrflags & (0x7UL << (4U)))
        {
          case ((0x1UL << (4U))):
             
            errorcode |= (0x00000008U);
            break;
          case ((0x2UL << (4U))):
             
            errorcode |= (0x00000010U);
            break;
          case ((0x2UL << (4U)) | (0x1UL << (4U))):
             
            errorcode |= (0x00000020U);
            break;
          case ((0x4UL << (4U))):
             
            errorcode |= (0x00000040U);
            break;
          case ((0x4UL << (4U)) | (0x1UL << (4U))):
             
            errorcode |= (0x00000080U);
            break;
          case ((0x4UL << (4U)) | (0x2UL << (4U))):
             
            errorcode |= (0x00000100U);
            break;
          default:
            break;
        }
        ...
        ((hcan->Instance ->ESR) &= ~((0x7UL << (4U))));
      }
    }

     
    (((((0x00000102U)) >> 8U) == 5U)? (((hcan)->Instance ->TSR) = (1U << (((0x00000102U)) & (0x000000FFU)))): ((((0x00000102U)) >> 8U) == 2U)? (((hcan)->Instance ->RF0R) = (1U << (((0x00000102U)) & (0x000000FFU)))): ((((0x00000102U)) >> 8U) == 4U)? (((hcan)->Instance ->RF1R) = (1U << (((0x00000102U)) & (0x000000FFU)))): ((((0x00000102U)) >> 8U) == 1U)? (((hcan)->Instance ->MSR) = (1U << (((0x00000102U)) & (0x000000FFU)))): 0U);
  }

   
  if (errorcode != (0x00000000U))
  {
...
HAL_CAN_StateTypeDef HAL_CAN_GetState(CAN_HandleTypeDef *hcan)
{
      ...
      (state == HAL_CAN_STATE_LISTENING))
  {
    ...
    else if ((hcan->Instance->MCR & (0x1UL << (1U))) != 0U)
    {
