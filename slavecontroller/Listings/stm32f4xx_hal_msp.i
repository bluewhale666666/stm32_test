...
#line 23 "C:\\Users\\LENOVO\\Desktop\\slavecontroller\\RTE\\Device\\STM32F407ZETx\\STCubeGenerated\\Src\\stm32f4xx_hal_msp.c"
...
void HAL_MspInit(void)
{
  ...
  HAL_NVIC_SetPriorityGrouping(0x00000004U);
...
void HAL_CAN_MspInit(CAN_HandleTypeDef* hcan)
{
  ...
  if(hcan->Instance==((CAN_TypeDef *) (0x40000000UL + 0x6400UL)))
  {
    ...
    GPIO_InitStruct.Pin = ((uint16_t)0x0800)|((uint16_t)0x1000);
...
void HAL_CAN_MspDeInit(CAN_HandleTypeDef* hcan)
{
  if(hcan->Instance==((CAN_TypeDef *) (0x40000000UL + 0x6400UL)))
  {
    ...
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0000UL)), ((uint16_t)0x0800)|((uint16_t)0x1000));
...
{
  GPIO_InitTypeDef GPIO_InitStruct = {0};
  if(hi2c->Instance==((I2C_TypeDef *) (0x40000000UL + 0x5400UL)))
  {
    ...
    GPIO_InitStruct.Mode = ((0x2UL << 0U) | (0x1UL << 4U));
    GPIO_InitStruct.Pull = 0x00000000U;
    GPIO_InitStruct.Speed = 0x00000003U;
    ...
    do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR) |= ((0x1UL << (21U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR) & ((0x1UL << (21U)))); (void)tmpreg; } while(0U);
   

   
  }
  else if(hi2c->Instance==((I2C_TypeDef *) (0x40000000UL + 0x5800UL)))
  {
    ...
    do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR) |= ((0x1UL << (22U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR) & ((0x1UL << (22U)))); (void)tmpreg; } while(0U);
   

   
  }
  else if(hi2c->Instance==((I2C_TypeDef *) (0x40000000UL + 0x5C00UL)))
  {
    ...
    do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR) |= ((0x1UL << (23U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR) & ((0x1UL << (23U)))); (void)tmpreg; } while(0U);
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  if(hi2c->Instance==((I2C_TypeDef *) (0x40000000UL + 0x5400UL)))
  {
    ...
    (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR &= ~((0x1UL << (21U))));

    


 
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0040));

    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0080));
  ...
  else if(hi2c->Instance==((I2C_TypeDef *) (0x40000000UL + 0x5800UL)))
  {
    ...
    (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR &= ~((0x1UL << (22U))));

    


 
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0400));

    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0800));
  ...
  else if(hi2c->Instance==((I2C_TypeDef *) (0x40000000UL + 0x5C00UL)))
  {
    ...
    (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR &= ~((0x1UL << (23U))));

    


 
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL)), ((uint16_t)0x0200));

    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0000UL)), ((uint16_t)0x0100));
...
{
  GPIO_InitTypeDef GPIO_InitStruct = {0};
  if(hspi->Instance==((SPI_TypeDef *) (0x40000000UL + 0x3C00UL)))
  {
   

   
     
    do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR) |= ((0x1UL << (15U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR) & ((0x1UL << (15U)))); (void)tmpreg; } while(0U);
    ...
    GPIO_InitStruct.Pin = ((uint16_t)0x0400)|((uint16_t)0x0800)|((uint16_t)0x1000);
    GPIO_InitStruct.Mode = ((0x2UL << 0U) | (0x0UL << 4U));
    GPIO_InitStruct.Pull = 0x00000000U;
    GPIO_InitStruct.Speed = 0x00000003U;
    GPIO_InitStruct.Alternate = ((uint8_t)0x06);
    HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL)), &GPIO_InitStruct);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  if(hspi->Instance==((SPI_TypeDef *) (0x40000000UL + 0x3C00UL)))
  {
    ...
    (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR &= ~((0x1UL << (15U))));
    ...
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL)), ((uint16_t)0x0400)|((uint16_t)0x0800)|((uint16_t)0x1000));
...
{
  GPIO_InitTypeDef GPIO_InitStruct = {0};
  if(huart->Instance==((USART_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x1000UL)))
  {
   

   
     
    do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB2ENR) |= ((0x1UL << (4U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB2ENR) & ((0x1UL << (4U)))); (void)tmpreg; } while(0U);
  ...
  else if(huart->Instance==((USART_TypeDef *) (0x40000000UL + 0x4400UL)))
  {
   

   
     
    do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR) |= ((0x1UL << (17U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR) & ((0x1UL << (17U)))); (void)tmpreg; } while(0U);
    ...
    GPIO_InitStruct.Pin = ((uint16_t)0x0004)|((uint16_t)0x0008);
    GPIO_InitStruct.Mode = ((0x2UL << 0U) | (0x0UL << 4U));
    GPIO_InitStruct.Pull = 0x00000000U;
    GPIO_InitStruct.Speed = 0x00000003U;
    GPIO_InitStruct.Alternate = ((uint8_t)0x07);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  if(huart->Instance==((USART_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x1000UL)))
  {
    ...
    (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB2ENR &= ~((0x1UL << (4U))));
  ...
  else if(huart->Instance==((USART_TypeDef *) (0x40000000UL + 0x4400UL)))
  {
    ...
    (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR &= ~((0x1UL << (17U))));

    


 
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0000UL)), ((uint16_t)0x0004)|((uint16_t)0x0008));
