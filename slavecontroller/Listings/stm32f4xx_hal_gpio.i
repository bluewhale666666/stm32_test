#line 1 "D:\\Keil_v5\\ARM\\PACK\\Keil\\STM32F4xx_DFP\\2.16.0\\Drivers\\STM32F4xx_HAL_Driver\\Src\\stm32f4xx_hal_gpio.c"
...
#line 109 "D:\\Keil_v5\\ARM\\PACK\\Keil\\STM32F4xx_DFP\\2.16.0\\Drivers\\STM32F4xx_HAL_Driver\\Src\\stm32f4xx_hal_gpio.c"
...
void HAL_GPIO_Init(GPIO_TypeDef  *GPIOx, GPIO_InitTypeDef *GPIO_Init)
{
  ...
  for(position = 0U; position < 16U; position++)
  {
    ...
    if(iocurrent == ioposition)
    {
      ...
      if(((GPIO_Init->Mode & (0x3UL << 0U)) == (0x1UL << 0U)) ||           (GPIO_Init->Mode & (0x3UL << 0U)) == (0x2UL << 0U))
      ...
      if((GPIO_Init->Mode & (0x3UL << 16U)) != 0x00U)
      {
        ...
        temp |= ((uint32_t)((uint8_t)(((GPIOx) == (((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0000UL))))? 0U : ((GPIOx) == (((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL))))? 1U : ((GPIOx) == (((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL))))? 2U : ((GPIOx) == (((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0C00UL))))? 3U : ((GPIOx) == (((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1000UL))))? 4U : ((GPIOx) == (((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1400UL))))? 5U : ((GPIOx) == (((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1800UL))))? 6U : ((GPIOx) == (((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1C00UL))))? 7U : 8U)) << (4U * (position & 0x03U)));
...
void HAL_GPIO_DeInit(GPIO_TypeDef  *GPIOx, uint32_t GPIO_Pin)
{
  ...
  for(position = 0U; position < 16U; position++)
  {
    ...
    if(iocurrent == ioposition)
    {
      ...
      tmp = ((SYSCFG_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3800UL))->EXTICR[position >> 2U];
      tmp &= (0x0FU << (4U * (position & 0x03U)));
      if(tmp == ((uint32_t)((uint8_t)(((GPIOx) == (((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0000UL))))? 0U : ((GPIOx) == (((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL))))? 1U : ((GPIOx) == (((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL))))? 2U : ((GPIOx) == (((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0C00UL))))? 3U : ((GPIOx) == (((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1000UL))))? 4U : ((GPIOx) == (((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1400UL))))? 5U : ((GPIOx) == (((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1800UL))))? 6U : ((GPIOx) == (((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1C00UL))))? 7U : 8U)) << (4U * (position & 0x03U))))
      {
         
        ((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->IMR &= ~((uint32_t)iocurrent);
        ((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->EMR &= ~((uint32_t)iocurrent);
        
         
        ((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->RTSR &= ~((uint32_t)iocurrent);
        ((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->FTSR &= ~((uint32_t)iocurrent);

         
        tmp = 0x0FU << (4U * (position & 0x03U));
        ((SYSCFG_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3800UL))->EXTICR[position >> 2U] &= ~tmp;
      }
...
void HAL_GPIO_EXTI_IRQHandler(uint16_t GPIO_Pin)
{
  ...
  if((((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->PR & (GPIO_Pin)) != RESET)
  {
    (((EXTI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3C00UL))->PR = (GPIO_Pin));
