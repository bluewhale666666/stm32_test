...
unsigned char COE_ContinueInd(TMBX  * pMbx)
{
    if (pCoeSendStored)
    {
        ...
        if (MBX_MailboxSendReq(pCoeSendStored, ((unsigned char) 0x0002)) == 0)
        {
            pCoeSendStored = 0;
        }
