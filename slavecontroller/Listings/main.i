...
#line 5 ".\\Power\\KeyIn.h"
#line 6 ".\\Power\\KeyIn.h"
...
static void MX_CAN1_Init(void)
{
  ...
  hcan1.Init.SyncJumpWidth = (0x00000000U);
  hcan1.Init.TimeSeg1 = (0x00000000U);
  hcan1.Init.TimeSeg2 = (0x00000000U);
...
static void MX_I2C1_Init(void)
{
  ...
  hi2c1.Instance = ((I2C_TypeDef *) (0x40000000UL + 0x5400UL));
...
static void MX_I2C3_Init(void)
{
  ...
  hi2c3.Init.AddressingMode = 0x00004000U;
...
static void MX_SPI3_Init(void)
{
  ...
  hspi3.Instance = ((SPI_TypeDef *) (0x40000000UL + 0x3C00UL));
  hspi3.Init.Mode = ((0x1UL << (2U)) | (0x1UL << (8U)));
  hspi3.Init.Direction = (0x00000000U);
  hspi3.Init.DataSize = (0x00000000U);
  hspi3.Init.CLKPolarity = (0x00000000U);
  hspi3.Init.CLKPhase = (0x00000000U);
  hspi3.Init.NSS = (0x1UL << (9U));
  hspi3.Init.BaudRatePrescaler = ((0x2UL << (3U)));
  hspi3.Init.FirstBit = (0x00000000U);
  hspi3.Init.TIMode = (0x00000000U);
  hspi3.Init.CRCCalculation = (0x00000000U);
...
static void MX_USART1_UART_Init(void)
{
  ...
  huart1.Instance = ((USART_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x1000UL));
  huart1.Init.BaudRate = 19200;
  huart1.Init.WordLength = 0x00000000U;
  huart1.Init.StopBits = 0x00000000U;
  huart1.Init.Parity = 0x00000000U;
  huart1.Init.Mode = ((uint32_t)((0x1UL << (3U)) | (0x1UL << (2U))));
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL)), ((uint16_t)0x0010)|((uint16_t)0x0020)|((uint16_t)0x0100), GPIO_PIN_SET);

   
  HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0002)|((uint16_t)0x0200), GPIO_PIN_RESET);

   
  HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1000UL)), ((uint16_t)0x0400)|((uint16_t)0x0800)|((uint16_t)0x1000)|((uint16_t)0x2000)
                          |((uint16_t)0x4000), GPIO_PIN_SET);

   
  HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x1000)|((uint16_t)0x2000)|((uint16_t)0x4000)|((uint16_t)0x8000), GPIO_PIN_SET);

   
  HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0C00UL)), ((uint16_t)0x0100)|((uint16_t)0x0200)|((uint16_t)0x0400), GPIO_PIN_SET);

   
  HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1800UL)), ((uint16_t)0x0010)|((uint16_t)0x0040)|((uint16_t)0x0080)|((uint16_t)0x0100), GPIO_PIN_SET);

   
  GPIO_InitStruct.Pin = ((uint16_t)0x0004)|((uint16_t)0x0008);
  GPIO_InitStruct.Mode = ((0x0UL << 0U) | (0x1UL << 16U) | (0x2UL << 20U));
  GPIO_InitStruct.Pull = 0x00000000U;
  HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1000UL)), &GPIO_InitStruct);

   
  GPIO_InitStruct.Pin = ((uint16_t)0x0040)|((uint16_t)0x0002);
  ...
  GPIO_InitStruct.Pin = ((uint16_t)0x0004)|((uint16_t)0x1000)|((uint16_t)0x2000);
  GPIO_InitStruct.Mode = ((0x1UL << 0U) | (0x0UL << 4U));
  GPIO_InitStruct.Pull = 0x00000000U;
  GPIO_InitStruct.Speed = 0x00000000U;
  ...
  GPIO_InitStruct.Pin = ((uint16_t)0x0008)|((uint16_t)0x0010)|((uint16_t)0x0020)|((uint16_t)0x0100)
                          |((uint16_t)0x0200)|((uint16_t)0x0400);
  GPIO_InitStruct.Mode = ((0x1UL << 0U) | (0x1UL << 4U));
  GPIO_InitStruct.Pull = 0x00000000U;
  GPIO_InitStruct.Speed = 0x00000000U;
  HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1400UL)), &GPIO_InitStruct);
  ...
  GPIO_InitStruct.Pin = ((uint16_t)0x0010)|((uint16_t)0x0020)|((uint16_t)0x0100);
  GPIO_InitStruct.Mode = ((0x1UL << 0U) | (0x1UL << 4U));
  GPIO_InitStruct.Pull = 0x00000000U;
  GPIO_InitStruct.Speed = 0x00000000U;
  ...
  GPIO_InitStruct.Pin = ((uint16_t)0x0002)|((uint16_t)0x0200);
  GPIO_InitStruct.Mode = ((0x1UL << 0U) | (0x0UL << 4U));
  GPIO_InitStruct.Pull = 0x00000000U;
  GPIO_InitStruct.Speed = 0x00000000U;
  ...
  GPIO_InitStruct.Pin = ((uint16_t)0x0002)|((uint16_t)0x0004)|((uint16_t)0x0008)|((uint16_t)0x0020)
                          |((uint16_t)0x0200)|((uint16_t)0x0400)|((uint16_t)0x0800)|((uint16_t)0x1000)
                          |((uint16_t)0x2000)|((uint16_t)0x4000);
  GPIO_InitStruct.Mode = (0x0UL << 0U);
  GPIO_InitStruct.Pull = 0x00000000U;
  ...
  GPIO_InitStruct.Pin = ((uint16_t)0x0400)|((uint16_t)0x0800)|((uint16_t)0x1000)|((uint16_t)0x2000)
                          |((uint16_t)0x4000);
  GPIO_InitStruct.Mode = ((0x1UL << 0U) | (0x1UL << 4U));
  GPIO_InitStruct.Pull = 0x00000000U;
  GPIO_InitStruct.Speed = 0x00000000U;
  ...
  GPIO_InitStruct.Pin = ((uint16_t)0x8000)|((uint16_t)0x0001);
  GPIO_InitStruct.Mode = (0x0UL << 0U);
  GPIO_InitStruct.Pull = 0x00000000U;
  HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1000UL)), &GPIO_InitStruct);

   
  GPIO_InitStruct.Pin = ((uint16_t)0x1000)|((uint16_t)0x2000)|((uint16_t)0x4000)|((uint16_t)0x8000);
  GPIO_InitStruct.Mode = ((0x1UL << 0U) | (0x1UL << 4U));
  GPIO_InitStruct.Pull = 0x00000000U;
  GPIO_InitStruct.Speed = 0x00000000U;
  HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), &GPIO_InitStruct);
  ...
  GPIO_InitStruct.Pin = ((uint16_t)0x0100)|((uint16_t)0x0200)|((uint16_t)0x0400);
  GPIO_InitStruct.Mode = ((0x1UL << 0U) | (0x1UL << 4U));
  GPIO_InitStruct.Pull = 0x00000000U;
  GPIO_InitStruct.Speed = 0x00000000U;
  ...
  GPIO_InitStruct.Pin = ((uint16_t)0x0800)|((uint16_t)0x1000)|((uint16_t)0x2000)|((uint16_t)0x4000)
                          |((uint16_t)0x8000)|((uint16_t)0x0040)|((uint16_t)0x0080);
  GPIO_InitStruct.Mode = (0x0UL << 0U);
  GPIO_InitStruct.Pull = 0x00000000U;
  HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0C00UL)), &GPIO_InitStruct);
  ...
  GPIO_InitStruct.Pin = ((uint16_t)0x0040)|((uint16_t)0x0080)|((uint16_t)0x0100);
  GPIO_InitStruct.Mode = ((0x1UL << 0U) | (0x1UL << 4U));
  GPIO_InitStruct.Pull = 0x00000000U;
  GPIO_InitStruct.Speed = 0x00000000U;
  HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1800UL)), &GPIO_InitStruct);
  ...
  HAL_NVIC_SetPriority(EXTI2_IRQn, 6, 1);
...
void PHY_Init(void)
{
	...
	elapseTime = 0u;
	((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1400UL))->ODR &= 0xffefu;
	...
	((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1400UL))->ODR |= ((uint32_t)1u << 4u);
}
