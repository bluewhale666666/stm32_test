...
#line 123 "etherCAT\\coeappl.c"

#line 1 "etherCAT\\coeappl.h"
...
typedef struct  {
    unsigned short   u16SubIndex0;  
    unsigned int   u32VendorID;  
    unsigned int   u32Productcode;  
    unsigned int   u32Revision;  
    unsigned int   u32Serialnumber;  
} 
TOBJ1018;
...
;
 ...
 unsigned int u32LastDc32Value;
 unsigned int u32CheckForDcOverrunCnt;
 ...
 void COE_Main(void);
 unsigned short COE_ObjDictionaryInit(void);
 unsigned short COE_AddObjectToDic(TOBJECT  * pNewObjEntry);
 void COE_RemoveDicEntry(unsigned short index);
 void COE_ClearObjDictionary(void);
 const TOBJECT  * COE_GetObjectDictionary(void);
 void COE_SyncTimeStamp(void);


 
#line 126 "etherCAT\\coeappl.c"
...
const TSDOINFOENTRYDESC     asEntryDesc0x1600[] = {
{ 0x0005 , 0x8 , 0x0007 },
{ 0x0007 , 0x20 , 0x0007 },  
{ 0x0007 , 0x20 , 0x0007 },  
{ 0x0007 , 0x20 , 0x0007 },  
...
const unsigned char  aName0x1600[] = "OUT_GENERIC process data mapping\000"
"SubIndex 001\000"
"SubIndex 002\000"
"SubIndex 003\000"
"SubIndex 004\000"
...
const TSDOINFOENTRYDESC     asEntryDesc0x1A00[] = {
{ 0x0005 , 0x8 , 0x0007 },
{ 0x0007 , 0x20 , 0x0007 },  
{ 0x0007 , 0x20 , 0x0007 },  
{ 0x0007 , 0x20 , 0x0007 },  
...
const unsigned char  aName0x1A00[] = "IN_GENERIC process data mapping\000"
"SubIndex 001\000"
"SubIndex 002\000"
"SubIndex 003\000"
"SubIndex 004\000"
...
const TSDOINFOENTRYDESC     asEntryDesc0x1C12[] = {
{ 0x0005 , 0x8 , 0x0007 },
{ 0x0006 , 0x10 , 0x0007 }};
...
const unsigned char  aName0x1C12[] = "SyncManager 2 assignment\000\377";
...
const TSDOINFOENTRYDESC     asEntryDesc0x1C13[] = {
{ 0x0005 , 0x8 , 0x0007 },
{ 0x0006 , 0x10 , 0x0007 }};
...
const unsigned char  aName0x1C13[] = "SyncManager 3 assignment\000\377";
...
const TSDOINFOENTRYDESC     asEntryDesc0x6000[] = {
{ 0x0005 , 0x8 , 0x0007 },
{ 0x0001 , 0x01 , 0x0007 },  
{ 0x0001 , 0x01 , 0x0007 },  
{ 0x0001 , 0x01 , 0x0007 },  
...
const unsigned char  aName0x6000[] = "IN_GENERIC\000"
...
const TSDOINFOENTRYDESC     asEntryDesc0x7000[] = {
{ 0x0005 , 0x8 , 0x0007 },
{ 0x0001 , 0x01 , 0x0007 },  
{ 0x0001 , 0x01 , 0x0007 },  
{ 0x0001 , 0x01 , 0x0007 },  
...
const unsigned char  aName0x7000[] = "OUT_GENERIC\000"
...
const TSDOINFOENTRYDESC     asEntryDesc0x8000[] = {
{ 0x0005 , 0x8 , 0x0007 },
{ 0x0007 , 0x20 , 0x003F },  
{ 0x0007 , 0x20 , 0x003F },  
{ 0x0006 , 0x10 , 0x003F },  
...
const unsigned char  aName0x8000[] = "Parameter Configuration\000"
"RS485_Baudrate\000"
"CAN_Baudrate\000"
"MotEncPerRotate\000"
...
const TSDOINFOENTRYDESC     asEntryDesc0xF000[] = {
{ 0x0005 , 0x8 , 0x0007 },
{ 0x0006 , 0x10 , 0x0007 },  
{ 0x0006 , 0x10 , 0x0007 }};  
...
const unsigned char  aName0xF000[] = "Modular Device Profile\000"
"Index distance \000"
...
{0 , 0 ,  0x1600 , {0x0021 , 65 | (0x09 << 8)} , asEntryDesc0x1600 , aName0x1600 , &OUT_GENERICProcessDataMapping0x1600 , 0 , 0 , 0x0000 },
 
{0 , 0 ,  0x1A00 , {0x0021 , 68 | (0x09 << 8)} , asEntryDesc0x1A00 , aName0x1A00 , &IN_GENERICProcessDataMapping0x1A00 , 0 , 0 , 0x0000 },
 
{0 , 0 ,  0x1C12 , {0x0006 , 1 | (0x08 << 8)} , asEntryDesc0x1C12 , aName0x1C12 , &sRxPDOassign , 0 , 0 , 0x0000 },
 
{0 , 0 ,  0x1C13 , {0x0006 , 1 | (0x08 << 8)} , asEntryDesc0x1C13 , aName0x1C13 , &sTxPDOassign , 0 , 0 , 0x0000 },
 
{0 , 0 ,  0x6000 , {0x002A , 68 | (0x09 << 8)} , asEntryDesc0x6000 , aName0x6000 , &IN_GENERIC0x6000 , 0 , 0 , 0x0000 },
 
{0 , 0 ,  0x7000 , {0x002A , 65 | (0x09 << 8)} , asEntryDesc0x7000 , aName0x7000 , &OUT_GENERIC0x7000 , 0 , 0 , 0x0000 },
 
{0 , 0 ,  0x8000 , {0x002A , 20 | (0x09 << 8)} , asEntryDesc0x8000 , aName0x8000 , &ParameterConfiguration0x8000 , 0 , 0 , 0x0000 },
 
{0 , 0 ,  0xF000 , {0x002A , 2 | (0x09 << 8)} , asEntryDesc0xF000 , aName0xF000 , &ModularDeviceProfile0xF000 , 0 , 0 , 0x0000 },
{0,0, 0xFFFF, {0, 0}, 0, 0, 0, 0}};
...
unsigned int u32Devicetype = (0x00001389);



 
const TSDOINFOENTRYDESC     sEntryDesc0x1000 = {0x0007, 0x20, 0x0007};



 
const unsigned char  aName0x1000[] = "Device type";
...
unsigned short u16ErrorRegister = 0x0;



 
const TSDOINFOENTRYDESC     sEntryDesc0x1001 = {0x0005, 0x08, 0x0007};



 
const unsigned char  aName0x1001[] = "Error register";
...
char acDevicename[] = "IO_ECAT_DC00";



 
const TSDOINFOENTRYDESC     sEntryDesc0x1008 = {0x0009, ((0xC)<<3), 0x0007};



 
const unsigned char  aName0x1008[] = "Device name";
...
char acHardwareversion[] = "0.0.0";



 
const TSDOINFOENTRYDESC     sEntryDesc0x1009 = {0x0009,((0x5)<<3), 0x0007};



 
const unsigned char  aName0x1009[] = "Manufacturer Hardware version";
...
char acSoftwareversion[] = "1.0.0";



 
const TSDOINFOENTRYDESC     sEntryDesc0x100A = {0x0009,((0x5)<<3), 0x0007};



 
const unsigned char  aName0x100A[] = "Manufacturer Software version";
...
TOBJ1018 sIdentity = {4, (0x8CF), (0x00000001), (0x00000001), (0x00000001)};
...
const TSDOINFOENTRYDESC     asEntryDesc0x1018[] = {
   {0x0005, 0x8, 0x0007 },
   {0x0007, 0x20, 0x0007}, 
   {0x0007, 0x20, 0x0007}, 
   {0x0007, 0x20, 0x0007}, 
...
const unsigned char  aName0x1018[] = "Identity Object\000Vendor ID\000Product Code\000Revision Number\000Serial Number\000\377";
...
const TSDOINFOENTRYDESC     asEntryDesc0x10F1[] = {
   {0x0005, 0x8, 0x0007 },
...
const unsigned char  aName0x10F1[] = "Error Settings\000Local Error Reaction\000Sync Error Counter Limit\000\377";
...
const TSDOINFOENTRYDESC     sEntryDesc0x10F8 = { 0x001B, 0x40, 0x003F | 0x0080 } ;


 
const unsigned char  aName0x10F8[] = "Timestamp Object\000\377";
...
unsigned char Read0x10F8(unsigned short index, unsigned char subindex, unsigned int dataSize, unsigned short  * pData, unsigned char bCompleteAccess)
{
...
void COE_SyncTimeStamp(void)
{
    ...
    if (b32BitDc)
    {
        unsigned int DcTime = (unsigned int)(u64Timestamp & (unsigned long long)0x00000000FFFFFFFF);


        HW_EscRead(((unsigned char *)&(DcTime)),((unsigned short)(0x0910)),4);

         
        u64Timestamp = ((u64Timestamp & ((unsigned long long)0xFFFFFFFF00000000)) | (unsigned long long)DcTime);

        if (DcTime < u32LastDc32Value)
        {
             
            u64Timestamp = u64Timestamp + ((unsigned long long)0x0000000100000000);
        }
    ...
    else
    {
        ...
        HW_EscRead((unsigned char *)&u64Timestamp, 0x0910, 8);
    }
...
const TSDOINFOENTRYDESC     asEntryDesc0x1C00[] = {
   {0x0005, 0x08, 0x0007},
   {0x0005, 0x08, 0x0007}};
...
const unsigned char  aName0x1C00[] = "Sync manager type";
...
const TSDOINFOENTRYDESC     asEntryDesc0x1C3x[] = {
   {0x0005, 0x8, 0x0007 },  
 
   {0x0006, 0x10, (0x0007 | 0x0008)},  
   {0x0007, 0x20, 0x0007},  
   {0x0000, 0x20, 0},  
   {0x0006, 0x10, 0x0007},  
   {0x0007, 0x20, 0x0007},  
...
const unsigned char  aName0x1C32[] = "SM output parameter\000Synchronization Type\000Cycle Time\000\000Synchronization Types supported\000Minimum Cycle Time\000Calc and Copy Time\000\000Get Cycle Time\000Delay Time\000Sync0 Cycle Time\000SM-Event Missed\000Cycle Time Too Small\000Shift Time Too Short Counter\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000Sync Error\000\377";



 
const unsigned char  aName0x1C33[] = "SM input parameter\000Synchronization Type\000Cycle Time\000\000Synchronization Types supported\000Minimum Cycle Time\000Calc and Copy Time\000\000Get Cycle Time\000Delay Time\000Sync0 Cycle Time\000SM-Event Missed\000Cycle Time Too Small\000Shift Time Too Short Counter\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000Sync Error\000\377";
...
TOBJECT     GenObjDic[] = {
   ...
   {0,0,  0x1000, {0x0007, 0 | (0x07 << 8)}, &sEntryDesc0x1000, aName0x1000, &u32Devicetype, 0, 0, 0x0000 },
    
   {0,0,  0x1001, {0x0005, 0 | (0x07 << 8)}, &sEntryDesc0x1001, aName0x1001, &u16ErrorRegister, 0, 0, 0x0000 },
 
   {0,0,  0x1008, {0x0009, 0 | (0x07 << 8)}, &sEntryDesc0x1008, aName0x1008, acDevicename, 0, 0, 0x0000 },
    
   {0,0,  0x1009, {0x0009, 0 | (0x07 << 8)}, &sEntryDesc0x1009, aName0x1009, acHardwareversion, 0, 0, 0x0000 },
    
   {0,0,  0x100A, {0x0009, 0 | (0x07 << 8)}, &sEntryDesc0x100A, aName0x100A, acSoftwareversion, 0, 0, 0x0000 },
 
    
   {0,0,  0x1018, {0x0023, 4 | (0x09 << 8)}, asEntryDesc0x1018, aName0x1018, &sIdentity, 0, 0, 0x0000 },
 
     
   {0,0,  0x10F1, {0x002A, 2 | (0x09 << 8)}, asEntryDesc0x10F1, aName0x10F1, &sErrorSettings, 0, 0, 0x0000 },
     
   { 0,0,  0x10F8,{ 0x001B, 0 | (0x07 << 8) }, &sEntryDesc0x10F8, aName0x10F8, &u64Timestamp, Read0x10F8, 0 , 0x0000 },
 
    
   {0,0, 0x1C00, {0x0005, 4 | (0x08 << 8)}, asEntryDesc0x1C00, aName0x1C00, &sSyncmanagertype, 0, 0, 0x0000 },
    
   {0,0, 0x1C32, {0x0029, 32 | (0x09 << 8)}, asEntryDesc0x1C3x, aName0x1C32, &sSyncManOutPar, 0, 0, 0x0000 },
    
   {0,0, 0x1C33, {0x0029, 32 | (0x09 << 8)}, asEntryDesc0x1C3x, aName0x1C33, &sSyncManInPar, 0, 0, 0x0000 },
   
   
  {0,0, 0xFFFF, {0, 0}, 0, 0, 0, 0, 0, 0x000}};
...
const TOBJECT  * COE_GetObjectDictionary(void)
{
    return (const TOBJECT  *) ObjDicList;
}
...
void COE_ObjInit(void)
{
    ...
    sSyncManOutPar.u16SyncType     = 0x0000;
    ...
    sSyncManOutPar.u16SyncTypesSupported    = 0x0001             
    ...
    sSyncManOutPar.u32MinCycleTime = 0;
    ...
    sSyncManOutPar.u32DelayTime = (0x0);
    ...
    sSyncManInPar.u16SyncType         = 0x0000;
    ...
    {
    unsigned short result = COE_ObjDictionaryInit();
    if(result != 0)
    {
    ...
    {
        unsigned int EscFeature = 0;
        HW_EscRead(((unsigned char *)&(EscFeature)),((unsigned short)(0x0008)),4);
        EscFeature = (EscFeature);

        if ((EscFeature & 0x00000008) > 0)
        {
            b32BitDc = 0;
        }
        else
        {
            ...
            HW_EscRead(((unsigned char *)&(u32LastDc32Value)),((unsigned short)(0x0910)),4);
        }

        u32CheckForDcOverrunCnt = 4000;
    }
}
...
void COE_RemoveDicEntry(unsigned short index)
{
    ...
    while(pDicEntry != 0)
    {
        ...
        {
            TOBJECT  *pPrevEntry = pDicEntry->pPrev;
            TOBJECT  *pNextEntry = pDicEntry->pNext;
...
void COE_ClearObjDictionary(void)
{
    TOBJECT  * pObjEntry = (TOBJECT  *) ObjDicList;
...
unsigned short AddObjectsToObjDictionary(TOBJECT  * pObjEntry)
{
    unsigned short result = 0;
    TOBJECT  * pEntry = (TOBJECT  *)pObjEntry;
...
unsigned short COE_ObjDictionaryInit(void)
{
    ...
    result = AddObjectsToObjDictionary((TOBJECT  *) GenObjDic);
    ...
    if(ApplicationObjDic != 0)
    {
        result = AddObjectsToObjDictionary((TOBJECT  *) ApplicationObjDic);
    }
