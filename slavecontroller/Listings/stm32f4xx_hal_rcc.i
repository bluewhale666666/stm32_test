#line 1 "D:\\Keil_v5\\ARM\\PACK\\Keil\\STM32F4xx_DFP\\2.16.0\\Drivers\\STM32F4xx_HAL_Driver\\Src\\stm32f4xx_hal_rcc.c"
...
#line 70 "D:\\Keil_v5\\ARM\\PACK\\Keil\\STM32F4xx_DFP\\2.16.0\\Drivers\\STM32F4xx_HAL_Driver\\Src\\stm32f4xx_hal_rcc.c"
  ...
  if ((RCC_OscInitStruct->PLL.PLLState) != ((uint8_t)0x00))
  {
    ...
    else
    {
      ...
      else
      {
        ...
        pll_config = ((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->PLLCFGR;
#line 552 "D:\\Keil_v5\\ARM\\PACK\\Keil\\STM32F4xx_DFP\\2.16.0\\Drivers\\STM32F4xx_HAL_Driver\\Src\\stm32f4xx_hal_rcc.c"
        if (((RCC_OscInitStruct->PLL.PLLState) == ((uint8_t)0x01)) ||
            (((pll_config) & ((0x1UL << (22U)))) != RCC_OscInitStruct->PLL.PLLSource) ||
            (((pll_config) & ((0x3FUL << (0U)))) != (RCC_OscInitStruct->PLL.PLLM) << (0U)) ||
            (((pll_config) & ((0x1FFUL << (6U)))) != (RCC_OscInitStruct->PLL.PLLN) << (6U)) ||
            (((pll_config) & ((0x3UL << (16U)))) != (((RCC_OscInitStruct->PLL.PLLP >> 1U) - 1U)) << (16U)) ||
            (((pll_config) & ((0xFUL << (24U)))) != (RCC_OscInitStruct->PLL.PLLQ << (24U))))
...
HAL_StatusTypeDef HAL_RCC_ClockConfig(RCC_ClkInitTypeDef  *RCC_ClkInitStruct, uint32_t FLatency)
{
  ...
  if(FLatency > ((((((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->ACR)) & ((0x7UL << (0U))))))
  {
    ...
    if(((((((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->ACR)) & ((0x7UL << (0U))))) != FLatency)
    {
      return HAL_ERROR;
    }
  }
  ...
  switch (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->CFGR & (0x3UL << (2U)))
  {
    ...
    case 0x00000008U:   
    {
      ...
      if(((uint32_t)(((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->PLLCFGR & (0x1UL << (22U)))) != 0x00000000U)
      {
        ...
        pllvco = (uint32_t) ((((uint64_t) 8000000U * ((uint64_t) ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->PLLCFGR & (0x1FFUL << (6U))) >> (6U))))) / (uint64_t)pllm);
      }
      else
      {
...
void HAL_RCC_GetClockConfig(RCC_ClkInitTypeDef  *RCC_ClkInitStruct, uint32_t *pFLatency)
{
  ...
  *pFLatency = (uint32_t)(((FLASH_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3C00UL))->ACR & (0x7UL << (0U)));
}
