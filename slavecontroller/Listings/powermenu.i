...
void close_all_dr_save_state(void)
{
  ...
  power_manage.p_state_l.VAL = 0x00u;
	...
	HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0200), GPIO_PIN_RESET);
  HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1400UL)), ((uint16_t)0x0004)|((uint16_t)0x1000), GPIO_PIN_RESET);
	HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1400UL)), ((uint16_t)0x2000), GPIO_PIN_SET);
}
...
void first_open_dr_save_state(void)
{
  ...
  power_manage.p_state_l.VAL = 0x7fu; 
	...
	HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0200), GPIO_PIN_SET);
  HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1400UL)), ((uint16_t)0x0004)|((uint16_t)0x1000), GPIO_PIN_SET);
}
