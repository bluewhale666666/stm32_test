...
#line 58 "etherCAT\\9252_HW.c"

#line 61 "etherCAT\\9252_HW.c"
...
static void GetInterruptRegister(void)
{
    ...
    HW_EscReadIsr((unsigned char *)&EscALEvent.Word, 0x220, 2);
...
unsigned char LAN9252_Init(void)
{
    ...
    do
    {
        data = PDIReadLAN9252DirectReg( 0x64);
    }while(0x87654321 != data);

    do
    {
        intMask = 0x93;
        HW_EscWrite(((unsigned char *)&(intMask)),((unsigned short)(0x0204)),2);
       
        intMask = 0;
        HW_EscRead(((unsigned char *)&(intMask)),((unsigned short)(0x0204)),2);
    } while (intMask != 0x93);

		
		data = 0x01;
		HW_EscWrite(((unsigned char *)&(data)),((unsigned short)(0x517)),2);
		
		
		data = 0x0000;
		HW_EscWrite(((unsigned char *)&(data)),((unsigned short)(0x512)),2);	
		
		
		data = 0x2100;
		HW_EscWrite(((unsigned char *)&(data)),((unsigned short)(0x514)),2);
		
		
		data = 0x0201;
		HW_EscWrite(((unsigned char *)&(data)),((unsigned short)(0x510)),2);		
    ...
    data = 0x00000101;
    PDIWriteLAN9252DirectReg(data, 0x54);
    
    
    
    data = 0x00000001;
    PDIWriteLAN9252DirectReg(data, 0x5C);

    
    data = PDIReadLAN9252DirectReg(0x58);
...
void HW_ResetALEventMask(unsigned short intMask)
{
    volatile unsigned int int_status;
    unsigned short mask;
    ...
    HW_EscRead(((unsigned char *)&(nAlEventMask)),((unsigned short)(0x0204)),2);
    PDI_Restore_Global_Interrupt(int_status);
}
...
void HW_SetALEventMask(unsigned short intMask)
{
    volatile unsigned int int_status;
    unsigned short mask;
...
void HW_EscRead( unsigned char *pData, unsigned short Address, unsigned short Len )
{
    volatile unsigned int int_status;
    unsigned short i;
...
void HW_EscReadIsr( unsigned char *pData, unsigned short Address, unsigned short Len )
{
...
void HW_EscWrite( unsigned char *pData, unsigned short Address, unsigned short Len )
{
    volatile unsigned int int_status;
    unsigned short i;
    unsigned char *pTmpData = (unsigned char *)pData;
...
void HW_EscWriteIsr( unsigned char *pData, unsigned short Address, unsigned short Len )
{
...
void HW_DisableSyncManChannel(unsigned char channel)
{
    unsigned short Offset;


    volatile unsigned int smStatus = 0x0100;
    smStatus = (smStatus);

    Offset = (0x0804 + (8*channel));

    HW_EscWrite(((unsigned char *)&(smStatus)),((unsigned short)(Offset)),4);

     
    do
    {
        HW_EscRead(((unsigned char *)&(smStatus)),((unsigned short)(Offset)),4);
...
void HW_EnableSyncManChannel(unsigned char channel)
{
    unsigned short Offset;

    volatile unsigned int smStatus = 0x00000000;
...
TSYNCMAN  * HW_GetSyncMan(unsigned char channel)
{
    
    HW_EscRead( (unsigned char *)&TmpSyncMan, 0x0800 + (channel * 8), 8 );
