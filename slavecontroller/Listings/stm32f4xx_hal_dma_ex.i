#line 1 "D:\\Keil_v5\\ARM\\PACK\\Keil\\STM32F4xx_DFP\\2.16.0\\Drivers\\STM32F4xx_HAL_Driver\\Src\\stm32f4xx_hal_dma_ex.c"
...
#line 41 "D:\\Keil_v5\\ARM\\PACK\\Keil\\STM32F4xx_DFP\\2.16.0\\Drivers\\STM32F4xx_HAL_Driver\\Src\\stm32f4xx_hal_dma_ex.c"
...
HAL_StatusTypeDef HAL_DMAEx_MultiBufferStart(DMA_HandleTypeDef *hdma, uint32_t SrcAddress, uint32_t DstAddress, uint32_t SecondMemAddress, uint32_t DataLength)
{
  ...
  if (hdma->Init.Direction == ((uint32_t)(0x2UL << (6U))))
  {
  ...
  else
  {
    ...
    if(HAL_DMA_STATE_READY == hdma->State)
    {
      ...
      hdma->Instance->CR |= (uint32_t)(0x1UL << (18U));
...
{  
  ...
  if((hdma->Init.Direction) == ((uint32_t)(0x1UL << (6U))))
  {   
