#line 1 "D:\\Keil_v5\\ARM\\PACK\\Keil\\STM32F4xx_DFP\\2.16.0\\Drivers\\STM32F4xx_HAL_Driver\\Src\\stm32f4xx_hal_dma.c"
...
#line 99 "D:\\Keil_v5\\ARM\\PACK\\Keil\\STM32F4xx_DFP\\2.16.0\\Drivers\\STM32F4xx_HAL_Driver\\Src\\stm32f4xx_hal_dma.c"
...
HAL_StatusTypeDef HAL_DMA_Init(DMA_HandleTypeDef *hdma)
{
  ...
  while((hdma->Instance->CR & (0x1UL << (0U))) != RESET)
  {
  ...
  tmp &= ((uint32_t)~((0x7UL << (25U)) | (0x3UL << (23U)) | (0x3UL << (21U)) |                       (0x3UL << (16U))    | (0x3UL << (13U))  | (0x3UL << (11U))  |                       (0x1UL << (10U))  | (0x1UL << (9U))   | (0x1UL << (8U))   |                       (0x3UL << (6U))   | (0x1UL << (19U))     | (0x1UL << (18U))));
  ...
  if(hdma->Init.FIFOMode == ((uint32_t)(0x1UL << (2U))))
  {
  ...
  tmp &= (uint32_t)~((0x1UL << (2U)) | (0x3UL << (0U)));
...
HAL_StatusTypeDef HAL_DMA_PollForTransfer(DMA_HandleTypeDef *hdma, HAL_DMA_LevelCompleteTypeDef CompleteLevel, uint32_t Timeout)
{
  ...
  if ((hdma->Instance->CR & (0x1UL << (8U))) != RESET)
  {
...
void HAL_DMA_IRQHandler(DMA_HandleTypeDef *hdma)
{
  ...
  if ((tmpisr & (0x00000008U << hdma->StreamIndex)) != RESET)
  {
    if((((((uint32_t)(0x1UL << (2U)))) != 0x00000080U)? ((hdma)->Instance ->CR & (((uint32_t)(0x1UL << (2U))))) : ((hdma)->Instance ->FCR & (((uint32_t)(0x1UL << (2U)))))) != RESET)
    {
       
      hdma->Instance->CR  &= ~(((uint32_t)(0x1UL << (2U))));
  ...
  if ((tmpisr & (0x00000004U << hdma->StreamIndex)) != RESET)
  {
    if((((((uint32_t)(0x1UL << (1U)))) != 0x00000080U)? ((hdma)->Instance ->CR & (((uint32_t)(0x1UL << (1U))))) : ((hdma)->Instance ->FCR & (((uint32_t)(0x1UL << (1U)))))) != RESET)
    {
  ...
  {
    if((((((uint32_t)(0x1UL << (3U)))) != 0x00000080U)? ((hdma)->Instance ->CR & (((uint32_t)(0x1UL << (3U))))) : ((hdma)->Instance ->FCR & (((uint32_t)(0x1UL << (3U)))))) != RESET)
    {
       
      regs->IFCR = 0x00000010U << hdma->StreamIndex;
      
       
      if(((hdma->Instance->CR) & (uint32_t)((0x1UL << (18U)))) != RESET)
      {
         
        if((hdma->Instance->CR & (0x1UL << (19U))) == RESET)
        {
          if(hdma->XferHalfCpltCallback != 0)
          {
  ...
  {
    if((((((uint32_t)(0x1UL << (4U)))) != 0x00000080U)? ((hdma)->Instance ->CR & (((uint32_t)(0x1UL << (4U))))) : ((hdma)->Instance ->FCR & (((uint32_t)(0x1UL << (4U)))))) != RESET)
    {
      ...
      else
      {
        if((hdma->Instance->CR & (0x1UL << (8U))) == RESET)
        {
          ...
          hdma->Instance->CR  &= ~(((uint32_t)(0x1UL << (4U))));
...
static HAL_StatusTypeDef DMA_CheckFifoParam(DMA_HandleTypeDef *hdma)
{
  ...
  if(hdma->Init.MemDataAlignment == 0x00000000U)
  {
    ...
    {
    case 0x00000000U:
    case ((uint32_t)(0x2UL << (0U))):
      if ((hdma->Init.MemBurst & (0x2UL << (23U))) == (0x2UL << (23U)))
      {
        status = HAL_ERROR;
      }
      break;
    case ((uint32_t)(0x1UL << (0U))):
      if (hdma->Init.MemBurst == ((uint32_t)(0x3UL << (23U))))
      {
        status = HAL_ERROR;
      }
      break;
    case ((uint32_t)(0x3UL << (0U))):
      break;
    default:
      break;
    }
  ...
  else if (hdma->Init.MemDataAlignment == ((uint32_t)(0x1UL << (13U))))
  {
    switch (tmp)
    {
    case 0x00000000U:
