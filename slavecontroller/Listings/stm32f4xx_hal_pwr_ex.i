#line 1 "D:\\Keil_v5\\ARM\\PACK\\Keil\\STM32F4xx_DFP\\2.16.0\\Drivers\\STM32F4xx_HAL_Driver\\Src\\stm32f4xx_hal_pwr_ex.c"
...
#line 26 "D:\\Keil_v5\\ARM\\PACK\\Keil\\STM32F4xx_DFP\\2.16.0\\Drivers\\STM32F4xx_HAL_Driver\\Src\\stm32f4xx_hal_pwr_ex.c"
...
HAL_StatusTypeDef HAL_PWREx_EnableBkUpReg(void)
{
  ...
  *(volatile uint32_t *) (uint32_t)(0x42000000UL + ((((0x40000000UL + 0x7000UL) - 0x40000000UL) + 0x04U) * 32U) + ((9U) * 4U)) = (uint32_t)ENABLE;

   
  tickstart = HAL_GetTick();

     
  while(((((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CSR & ((0x1UL << (3U)))) == ((0x1UL << (3U)))) == RESET)
  {
...
HAL_StatusTypeDef HAL_PWREx_DisableBkUpReg(void)
{
  ...
  *(volatile uint32_t *) (uint32_t)(0x42000000UL + ((((0x40000000UL + 0x7000UL) - 0x40000000UL) + 0x04U) * 32U) + ((9U) * 4U)) = (uint32_t)DISABLE;
...
void HAL_PWREx_EnableFlashPowerDown(void)
{
  *(volatile uint32_t *) (uint32_t)(0x42000000UL + ((((0x40000000UL + 0x7000UL) - 0x40000000UL) + 0x00U) * 32U) + ((9U) * 4U)) = (uint32_t)ENABLE;
}
...
void HAL_PWREx_DisableFlashPowerDown(void)
{
  *(volatile uint32_t *) (uint32_t)(0x42000000UL + ((((0x40000000UL + 0x7000UL) - 0x40000000UL) + 0x00U) * 32U) + ((9U) * 4U)) = (uint32_t)DISABLE;
}
...
uint32_t HAL_PWREx_GetVoltageRange(void)
{
  return (((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CR & (0x1UL << (14U)));
}
...
HAL_StatusTypeDef HAL_PWREx_ControlVoltageScaling(uint32_t VoltageScaling)
{
  ...
  do { volatile uint32_t tmpreg = 0x00U; (((((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CR)) = ((((((((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CR))) & (~((0x1UL << (14U))))) | ((VoltageScaling))))); tmpreg = ((((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CR) & ((0x1UL << (14U)))); (void)tmpreg; } while(0U);
  
   
  tickstart = HAL_GetTick();
  while((((((PWR_TypeDef *) (0x40000000UL + 0x7000UL))->CSR & ((0x1UL << (14U)))) == ((0x1UL << (14U)))) == RESET))
  {
    if((HAL_GetTick() - tickstart ) > 1000U)
    {
      return HAL_TIMEOUT;
...
#line 351 "D:\\Keil_v5\\ARM\\PACK\\Keil\\STM32F4xx_DFP\\2.16.0\\Drivers\\STM32F4xx_HAL_Driver\\Src\\stm32f4xx_hal_pwr_ex.c"

#line 401 "D:\\Keil_v5\\ARM\\PACK\\Keil\\STM32F4xx_DFP\\2.16.0\\Drivers\\STM32F4xx_HAL_Driver\\Src\\stm32f4xx_hal_pwr_ex.c"

#line 587 "D:\\Keil_v5\\ARM\\PACK\\Keil\\STM32F4xx_DFP\\2.16.0\\Drivers\\STM32F4xx_HAL_Driver\\Src\\stm32f4xx_hal_pwr_ex.c"
