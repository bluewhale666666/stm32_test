...
static ADS1115_DRIVER * ADS1115_ChipA_DriverPtr[2u] =
{
		&ADS1115_Voltage24V,
		&ADS1115_Current24V,
};
...
static  ADS1115_DRIVER * ADS1115_ChipB_DriverPtr[4u] = 
{
...
static ADS1115_DRIVER * ADS1115_ChipC_DriverPtr[3u] = 
{
		&ADS1115_Voltage48V,
		&ADS1115_Current48V,
		&ADS1115_NTC,	
...
ADS1115_DRIVER ADS1115_AnalogVoltageInput0 =
{
		...
		.ConfigRegData.ALL = ((uint16_t)1u << 15u) | 											((uint16_t)4u << 12u) | 											((uint16_t)1u << 9u) | 											(0u) | 											((uint16_t)7u << 5u) | 											0u | 											(0u) | 											(3u), 
#line 72 "Power\\ADS1115Driver.c"
...
ADS1115_DRIVER ADS1115_AnalogVoltageInput1 =
{
		...
		.ConfigRegData.ALL = ((uint16_t)1u << 15u) | 											((uint16_t)5u << 12u) | 											((uint16_t)1u << 9u) | 											(0u) | 											((uint16_t)7u << 5u) | 											0u | 											(0u) | 											(3u),
#line 93 "Power\\ADS1115Driver.c"
		.StartConversionTimerPtr = &ADCStartConversionTimer2,	
		.ConversionTime = 250u,
		.ConfigErrorCnt = 0u,
		.ConversionErrorCnt = 0u,
...
ADS1115_DRIVER ADS1115_AnalogCurrentInput0 =
{
		...
		.ConfigRegData.ALL = ((uint16_t)1u << 15u) | 											((uint16_t)7u << 12u) | 											((uint16_t)1u << 9u) | 											(0u) | 											((uint16_t)7u << 5u) | 											0u | 											(0u) | 											(3u),	
#line 114 "Power\\ADS1115Driver.c"
		.StartConversionTimerPtr = &ADCStartConversionTimer2,
		.ConversionTime = 250u,	
		.ConfigErrorCnt = 0u,
		.ConversionErrorCnt = 0u,
...
ADS1115_DRIVER ADS1115_AnalogCurrentInput1 =
{
		...
		.ConfigRegData.ALL = ((uint16_t)1u << 15u) | 											((uint16_t)6u << 12u) | 											((uint16_t)1u << 9u) | 											(0u) | 											((uint16_t)7u << 5u) | 											0u | 											(0u) | 											(3u),
#line 135 "Power\\ADS1115Driver.c"
		.StartConversionTimerPtr = &ADCStartConversionTimer2,	
		.ConversionTime = 250u,	
		.ConfigErrorCnt = 0u,
		.ConversionErrorCnt = 0u,
...
ADS1115_DRIVER ADS1115_Voltage48V =
{
		...
		.ConfigRegData.ALL = ((uint16_t)1u << 15u) | 											((uint16_t)4u << 12u) | 											((uint16_t)1u << 9u) | 											(0u) | 											((uint16_t)7u << 5u) | 											0u | 											(0u) | 											(3u),
#line 156 "Power\\ADS1115Driver.c"
...
ADS1115_DRIVER ADS1115_Current48V =
{
		...
		.ConfigRegData.ALL = ((uint16_t)1u << 15u) | 											((uint16_t)6u << 12u) | 											((uint16_t)1u << 9u) | 											(0u) | 											((uint16_t)7u << 5u) | 											0u | 											(0u) | 											(3u),
#line 177 "Power\\ADS1115Driver.c"
		.StartConversionTimerPtr = &ADCStartConversionTimer3,
		.ConversionTime = 250u,	
		.ConfigErrorCnt = 0u,
		.ConversionErrorCnt = 0u,
...
ADS1115_DRIVER ADS1115_NTC =
{
		...
		.ConfigRegData.ALL = ((uint16_t)1u << 15u) | 											((uint16_t)5u << 12u) | 											((uint16_t)1u << 9u) | 											(0u) | 											((uint16_t)7u << 5u) | 											0u | 											(0u) | 											(3u),
#line 198 "Power\\ADS1115Driver.c"
		.StartConversionTimerPtr = &ADCStartConversionTimer3,
		.ConversionTime = 250u,	
		.ConfigErrorCnt = 0u,
		.ConversionErrorCnt = 0u,
...
ADS1115_DRIVER ADS1115_Voltage24V =
{
		...
		.ConfigRegData.ALL = ((uint16_t)1u << 15u) | 											((uint16_t)4u << 12u) | 											((uint16_t)1u << 9u) | 											(0u) | 											((uint16_t)7u << 5u) | 											0u | 											(0u) | 											(3u),
#line 221 "Power\\ADS1115Driver.c"
...
ADS1115_DRIVER ADS1115_Current24V =
{
		...
		.ConfigRegData.ALL = ((uint16_t)1u << 15u) | 											((uint16_t)5u << 12u) | 											((uint16_t)1u << 9u) | 											(0u) | 											((uint16_t)7u << 5u) | 											0u | 											(0u) | 											(3u),
#line 242 "Power\\ADS1115Driver.c"
		.StartConversionTimerPtr = &ADCStartConversionTimer1,
		.ConversionTime = 250u,	
		.ConfigErrorCnt = 0u,
		.ConversionErrorCnt = 0u,
...
static void ADS1115_Read_Sample(ADS1115_DRIVER * strpADC)
{
	...
	{
		Data = 0x00;
		strpADC->ConversionTransmitResult = HAL_I2C_Master_Transmit(strpADC->I2C_Handle, strpADC->ADDR, &Data, 1u, 500u);
		strpADC->ConversionReceiveResult = HAL_I2C_Master_Receive(strpADC->I2C_Handle, strpADC->ADDR, strpADC->SampleBuffer, 2u, 500u);
...
static void ADS1115_Config(ADS1115_DRIVER * strpADC)
{
	...
	strpADC->ConfigResult = HAL_I2C_Master_Transmit(strpADC->I2C_Handle, strpADC->ADDR, Data, 3u, 500u);
	if(strpADC->ConfigResult == HAL_OK)
	{
...
void ADS1115_Driver_MainLoop(void)
{
	...
	if (elapseTime >= strpADC->ConversionTime)
	{
		  ...
		  if(ADS1115_ChipA_Driver_Cnt == 1u)
			{
				power_manage.dc24v_u = 409.6*8.5*strpADC->SampleValue/32768;
			}
			else if(ADS1115_ChipA_Driver_Cnt == 2u)
			{
				power_manage.dc24v_i = 409.6*strpADC->SampleValue/(0.5*32768);
			}
			
			if(ADS1115_ChipA_Driver_Cnt >= (uint8_t)2u)
			{
	...
	if (elapseTime >= strpADC->ConversionTime)
	{
		  ...
		  ADS1115_ChipB_Driver_Cnt++;
			...
			{
				power_manage.ai1_u = 409.6*2.8*strpADC->SampleValue/32768;	
			}
			else if(ADS1115_ChipB_Driver_Cnt == 2u)
			{
				power_manage.ai2_u = 409.6*2.8*strpADC->SampleValue/32768;	
			}
			else if(ADS1115_ChipB_Driver_Cnt == 3u)
			{
				power_manage.ai2_i = 409.6*strpADC->SampleValue/(0.16*32768);
			}
			else if(ADS1115_ChipB_Driver_Cnt == 4u)
			{
				power_manage.ai1_i = 409.6*strpADC->SampleValue/(0.16*32768);
			}
		
			if(ADS1115_ChipB_Driver_Cnt >= (uint8_t)4u)
			{
	...
	if (elapseTime >= strpADC->ConversionTime)
	{
			...
			{
				power_manage.dc48v_u = 409.6*31.5*strpADC->SampleValue/(1.5*32768);
			}
			...
			{
				power_manage.dc48v_i = 409.6*strpADC->SampleValue/(0.05*32768);
			}
			
			if(ADS1115_ChipC_Driver_Cnt >= (uint8_t)3u)
			{
