...
void PowerOnKeyInState(void)
{
	...
	{
		case 0u: 
			if(HAL_GPIO_ReadPin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1000UL)),((uint16_t)0x0001)) == GPIO_PIN_RESET)
			{
		...
		case 2u:
			...
			break;
		case 3u:
		  if(HAL_GPIO_ReadPin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1000UL)),((uint16_t)0x0001)) == GPIO_PIN_SET)
			{
...
void PowerOnRemoteKeyInState(void)
{
	...
	{
		case 0u: 
			if(HAL_GPIO_ReadPin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)),((uint16_t)0x0100)) == GPIO_PIN_RESET)
			{
		...
		case 2u:
			...
			break;
		case 3u:
		  if(HAL_GPIO_ReadPin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)),((uint16_t)0x0100)) == GPIO_PIN_SET)
			{
				power_manage.work_mode = POWER_STATUS_POWERON;
				POWERONREMOTE_KEYIN_STATE = 0u;
			}
...
void PowerOffREMOTEKeyInState(void)
{
	...
	{
		case 0u: 
			if(HAL_GPIO_ReadPin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1000UL)),((uint16_t)0x8000)) == GPIO_PIN_RESET)
			{
		...
		case 2u:
			...
			break;
		case 3u:
		  if(HAL_GPIO_ReadPin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1000UL)),((uint16_t)0x8000)) == GPIO_PIN_SET)
			{
				power_manage.work_mode = POWER_STATUS_SHUTDWON;
				POWEROFFREMOTE_KEYIN_STATE = 0u;
			}
