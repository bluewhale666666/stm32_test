...
/*ET9300 Project Handler :(#if ESC_32BIT_ACCESS) lines 188 to 190 deleted*/
    extern VARVOLATILE UINT16    u16dummy;
/*ET9300 Project Handler :( #else) lines 192 to 194 deleted*/
...
/*ET9300 Project Handler :(#if ESC_32BIT_ACCESS) lines 318 to 325 deleted*/
    {
...
/*ET9300 Project Handler :( #else) lines 332 to 339 deleted*/
    bMbxRunning = FALSE;
...
/*ET9300 Project Handler :(#if ESC_32BIT_ACCESS) lines 511 to 518 deleted*/
    {
        UINT16 sm1Activate = 0;
        HW_EscReadWord(sm1Activate,(ESC_SYNCMAN_ACTIVE_OFFSET + SIZEOF_SM_REGISTER));
        sm1Activate &= SWAPWORD(~0x0200);
...
/*ET9300 Project Handler :( #else) lines 525 to 532 deleted*/
    bSendMbxIsFull         = FALSE;
    bReceiveMbxIsLocked = FALSE;
    u8MailboxSendReqStored    = 0;
    u8MbxWriteCounter         = 0;
...
/*ET9300 Project Handler :(#if ESC_32BIT_ACCESS) lines 1223 to 1227 deleted*/
        VARVOLATILE UINT16 smstate = 0x00;
        HW_EscReadWord(smstate,ESC_SYNCMAN_CONTROL_OFFSET);
        smstate = SWAPWORD(smstate);
/*ET9300 Project Handler :( #else) lines 1231 to 1234 deleted*/

        if(smstate & SM_STATUS_MBX_BUFFER_FULL)
        {
            /*Unlock the mailbox SyncManger buffer*/
/*ET9300 Project Handler :(#if ESC_32BIT_ACCESS) lines 1239 to 1242 deleted*/
            u16dummy = 0;
            HW_EscReadWord(u16dummy,(u16EscAddrReceiveMbx + u16ReceiveMbxSize - 2));
/*ET9300 Project Handler :( #else) lines 1245 to 1248 deleted*/
...
/*ET9300 Project Handler :(#if ESC_32BIT_ACCESS) lines 1301 to 1314 deleted*/
...
/*ET9300 Project Handler :( #else) lines 1326 to 1336 deleted*/
        }
...
/*ET9300 Project Handler :(#if ESC_32BIT_ACCESS) lines 1345 to 1349 deleted*/
        VARVOLATILE UINT16 smstate = 0x00;
        HW_EscReadWord(smstate,(ESC_SYNCMAN_CONTROL_OFFSET + SIZEOF_SM_REGISTER));
        smstate = SWAPWORD(smstate);
/*ET9300 Project Handler :( #else) lines 1353 to 1356 deleted*/
...
/*ET9300 Project Handler :(#if ESC_32BIT_ACCESS) lines 1366 to 1382 deleted*/
...
/*ET9300 Project Handler :( #else) lines 1397 to 1400 deleted*/
        }
        }
