...
/*ET9300 Project Handler :(#if ESC_32BIT_ACCESS) lines 274 to 276 deleted*/
    VARVOLATILE UINT16    u16dummy;
/*ET9300 Project Handler :( #else) lines 278 to 280 deleted*/

/*ET9300 Project Handler :(#if !COE_SUPPORTED) lines 282 to 288 deleted*/

/*ET9300 Project Handler :(#if ESC_32BIT_ACCESS) lines 290 to 292 deleted*/
        VARVOLATILE UINT16 SMActivate = 0;
/*ET9300 Project Handler :( #else) lines 294 to 296 deleted*/
...
{
    UINT16 Offset;
/*ET9300 Project Handler :(#if ESC_32BIT_ACCESS) lines 488 to 507 deleted*/
...
/*ET9300 Project Handler :(#if BIG_ENDIAN_FORMAT) lines 512 to 514 deleted*/
...
/*ET9300 Project Handler :(#if BIG_ENDIAN_FORMAT) lines 522 to 524 deleted*/
    }while(!(smStatus & SM_SETTING_PDI_DISABLE));
/*ET9300 Project Handler :( #else) lines 526 to 537 deleted*/
}
...
{
    UINT16 Offset;
/*ET9300 Project Handler :(#if ESC_32BIT_ACCESS) lines 549 to 569 deleted*/
    //The register 0x806 is only readable from PDI => writing 0 is valid
    VARVOLATILE UINT16 smStatus = 0x0000;
    Offset = (ESC_SYNCMAN_ACTIVE_OFFSET + (SIZEOF_SM_REGISTER*channel));

/*ET9300 Project Handler :(#if BIG_ENDIAN_FORMAT) lines 574 to 576 deleted*/
    ...
    {
        HW_EscReadWord(smStatus,Offset);
/*ET9300 Project Handler :(#if BIG_ENDIAN_FORMAT) lines 584 to 586 deleted*/

    }while((smStatus & SM_SETTING_PDI_DISABLE));
/*ET9300 Project Handler :( #else) lines 589 to 600 deleted*/
}
...
/*ET9300 Project Handler :(#if MAX_PD_OUTPUT_SIZE > 0 #else) lines 731 to 736 deleted*/
                break;
...
/*ET9300 Project Handler :(#if ESC_32BIT_ACCESS) lines 744 to 746 deleted*/
...
/*ET9300 Project Handler :(#if MAX_PD_INPUT_SIZE > 0 #else) lines 774 to 779 deleted*/
                break;
            case SYNCMANCHSETTINGS:
...
/*ET9300 Project Handler :(#if ESC_32BIT_ACCESS) lines 788 to 790 deleted*/
                    pEmcy->Emcy.RegData[EMCY_OFFS_DIAGDATA+1] = SWAPWORD(SM_SETTING_ENABLE_VALUE);
                }
                else
                {
...
/*ET9300 Project Handler :(#if MAX_PD_INPUT_SIZE > 0 #else) lines 1121 to 1127 deleted*/
        ...
        if ( result != 0 )
        {
/*ET9300 Project Handler :(#if DIAGNOSIS_SUPPORTED) lines 1131 to 1133 deleted*/
...
/*ET9300 Project Handler :(#if TEST_APPLICATION && COE_SUPPORTED) lines 1258 to 1265 deleted*/
        if ( result != 0 )
        {
/*ET9300 Project Handler :(#if DIAGNOSIS_SUPPORTED) lines 1268 to 1270 deleted*/
            /* state transition refused, send an Emergency with the error and the correct settings */
...
/*ET9300 Project Handler :(#if ESC_32BIT_ACCESS) lines 1312 to 1314 deleted*/
    UINT16        dcControl;
/*ET9300 Project Handler :( #else) lines 1316 to 1318 deleted*/
...
/*ET9300 Project Handler :(#if ESC_32BIT_ACCESS) lines 1387 to 1389 deleted*/
    ...
    {
/*ET9300 Project Handler :(#if DIAGNOSIS_SUPPORTED) lines 1407 to 1409 deleted*/
...
/*ET9300 Project Handler :(#if DIAGNOSIS_SUPPORTED) lines 1435 to 1438 deleted*/
...
/*ET9300 Project Handler :(#if ESC_32BIT_ACCESS) lines 1450 to 1455 deleted*/
...
/*ET9300 Project Handler :( #else) lines 1459 to 1462 deleted*/
...
/*ET9300 Project Handler :(#if ESC_32BIT_ACCESS) lines 2418 to 2425 deleted*/
    {
    UINT16 TmpVar = 0;
    TmpVar = SWAPWORD((((UINT16)u8EcatRunLed) | (((UINT16)u8EcatErrorLed)<<8)));
    HW_EscWriteWord(TmpVar,ESC_RUN_LED_OVERRIDE);
    }
/*ET9300 Project Handler :(#if ESC_32BIT_ACCESS || ESC_16BIT_ACCESS #else) lines 2432 to 2434 deleted*/
}
...
/*ET9300 Project Handler :(#if MAILBOX_SUPPORTED #else) lines 2614 to 2616 deleted*/
...
/*ET9300 Project Handler :(#if BOOTSTRAPMODE_SUPPORTED #else) lines 2624 to 2626 deleted*/
...
/*ECATCHANGE_END(V5.13) ECAT1*/
            ...
            BL_Stop();
/*ET9300 Project Handler :(#if BOOTSTRAPMODE_SUPPORTED #else) lines 2650 to 2652 deleted*/
...
/*ET9300 Project Handler :(#if ESC_32BIT_ACCESS) lines 3756 to 3768 deleted*/
    {
    UINT16 TmpVar = 0;
...
/*ET9300 Project Handler :( #else) lines 3783 to 3789 deleted*/
...
/*ET9300 Project Handler :(#if ESC_32BIT_ACCESS) lines 3891 to 3894 deleted*/
...
/*ET9300 Project Handler :( #else) lines 3897 to 3900 deleted*/
...
/*ECATCHANGE_START(V5.13) MBX1*/
/*ET9300 Project Handler :(#if ESC_32BIT_ACCESS) lines 3956 to 3961 deleted*/
...
/*ET9300 Project Handler :( #else) lines 3968 to 3973 deleted*/
/*ECATCHANGE_END(V5.13) MBX1*/
    }
...
/*ET9300 Project Handler :(#if ESC_32BIT_ACCESS) lines 3993 to 3998 deleted*/

        HW_EscReadWord( EscAlControl, ESC_AL_CONTROL_OFFSET);
        EscAlControl = SWAPWORD(EscAlControl);
/*ET9300 Project Handler :( #else) lines 4002 to 4006 deleted*/
...
/*ET9300 Project Handler :(#if ESC_32BIT_ACCESS) lines 4095 to 4098 deleted*/
            u16dummy = 0;
            HW_EscWriteWord(u16dummy,u16EscAddrSendMbx);
/*ET9300 Project Handler :( #else) lines 4101 to 4104 deleted*/
...
/*ET9300 Project Handler :(#if ESC_32BIT_ACCESS) lines 4126 to 4138 deleted*/
                if (bMbxRepeatToggle)
                {
...
/*ET9300 Project Handler :( #else) lines 4150 to 4153 deleted*/
            }
