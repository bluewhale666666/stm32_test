...
UINT8 LAN9252_Init(void)
{
    ...
    do
    {
		...
		//Enable PDI access to MII management
		data = 0x01;
		HW_EscWriteWord(data, 0x517);
		
		//Select PHY0
		data = 0x0000;
		HW_EscWriteWord(data, 0x512);	
		
		//Disable Auto-Negotiation and force link speed to 100mbps / full duplex
		data = 0x2100;
		HW_EscWriteWord(data, 0x514);
		
		//Enable write operation, MDPI control only
		data = 0x0201;
		HW_EscWriteWord(data, 0x510);		
