...
extern "C" {
    ...
    typedef union {
        UINT32 Val;
        UINT16 w[2] __attribute__((packed));
        UINT8  v[4];
        struct __attribute__((packed)) {
            UINT16 LW;
            UINT16 HW;
...
#define ECAT_SPI_TIMEOUT 2000u
		
extern SPI_HandleTypeDef *EcatHspiPtr;
extern UINT8 EcatSpiReadBuffer[SPI_BUFFER_SIZE];
extern UINT8 EcatSpiWriteBuffer[SPI_BUFFER_SIZE];
	// *****************************************************************************
	// *****************************************************************************
