...
\brief Implementation
 Created with SSC Tool application parser 1.6.1.0
\version 0.0.0.1
*/
...
//#endif
		memcpy((UINT8*)pData,(UINT8*)&IN_GENERIC0x6000 + 2,sizeof(IN_GENERIC0x6000) - 2);
}
...
//#endif
		memcpy((UINT8*)&OUT_GENERIC0x7000 + 2,(UINT8*)pData,sizeof(OUT_GENERIC0x7000) - 2);
}
