...
/*ET9300 Project Handler :(#if FC1100_HW) lines 71 to 73 deleted*/
...
/*ET9300 Project Handler :(#if BIG_ENDIAN_16BIT) lines 94 to 97 deleted*/
...
/*ET9300 Project Handler :(#if FC1100_HW) lines 128 to 130 deleted*/
