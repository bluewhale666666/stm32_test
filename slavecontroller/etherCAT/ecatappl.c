...
/*ET9300 Project Handler :(#if ESC_32BIT_ACCESS) lines 252 to 254 deleted*/
    extern VARVOLATILE UINT16    u16dummy;
/*ET9300 Project Handler :( #else) lines 256 to 258 deleted*/
...
/*ET9300 Project Handler :(#if UC_SET_ECAT_LED) lines 451 to 453 deleted*/
...
/*ET9300 Project Handler :(#if ESC_32BIT_ACCESS) lines 682 to 685 deleted*/
            HW_EscReadWordIsr(u16dummy,nEscAddrOutputData);
            HW_EscReadWordIsr(u16dummy,(nEscAddrOutputData+nPdOutputSize-2));
/*ET9300 Project Handler :( #else) lines 688 to 691 deleted*/
        }
        }
...
/*ET9300 Project Handler :(#if ESC_32BIT_ACCESS) lines 780 to 783 deleted*/
            HW_EscReadWordIsr(u16dummy,nEscAddrOutputData);
            HW_EscReadWordIsr(u16dummy,(nEscAddrOutputData+nPdOutputSize-2));
/*ET9300 Project Handler :( #else) lines 786 to 789 deleted*/
    }
...
*////////////////////////////////////////////////////////////////////////////////////////
/*ET9300 Project Handler :(#if UC_SET_ECAT_LED) lines 1041 to 1218 deleted*/
/////////////////////////////////////////////////////////////////////////////////////////
/**
...
/*ET9300 Project Handler :(#if DIAGNOSIS_SUPPORTED) lines 1277 to 1280 deleted*/
    ...
    /*Reset PDI Access*/
    {
/*ET9300 Project Handler :(#if ESC_32BIT_ACCESS) lines 1285 to 1299 deleted*/
...
/*ET9300 Project Handler :(#if ESC_32BIT_ACCESS) lines 1667 to 1675 deleted*/
    UINT16 nConfig;
...
/*ET9300 Project Handler :(#if BIG_ENDIAN_FORMAT) lines 1682 to 1685 deleted*/


/*ET9300 Project Handler :(#if ESC_32BIT_ACCESS) lines 1689 to 1691 deleted*/
...
/*ET9300 Project Handler :(#if ESC_32BIT_ACCESS) lines 1703 to 1705 deleted*/
...
/*ET9300 Project Handler :(#if ESC_32BIT_ACCESS) lines 1719 to 1733 deleted*/
        nConfig = ESC_EEPROM_LOCKED_BY_PDI_MASK;
/*ET9300 Project Handler :(#if BIG_ENDIAN_FORMAT) lines 1735 to 1737 deleted*/
        HW_EscWriteWord(nConfig,ESC_EEPROM_CONFIG_OFFSET);
        for (i = 0; i < wordsize;)
        {
            /* we have to set the start address in register 0x504-0x507 */
/*ET9300 Project Handler :(#if BIG_ENDIAN_FORMAT) lines 1743 to 1746 deleted*/
/*ET9300 Project Handler :(#if ESC_32BIT_ACCESS) lines 1747 to 1749 deleted*/
...
/*ET9300 Project Handler :(#if ESC_32BIT_ACCESS) lines 1758 to 1766 deleted*/
                nControl = ESC_EEPROM_CMD_READ_MASK;
/*ET9300 Project Handler :(#if BIG_ENDIAN_FORMAT) lines 1768 to 1770 deleted*/
                HW_EscWriteWord(nControl,ESC_EEPROM_CONTROL_OFFSET);
            }
            else
            {
                /* write access, we write the data in register 0x508-0x509 */
/*ET9300 Project Handler :(#if ESC_32BIT_ACCESS) lines 1777 to 1789 deleted*/
...
/*ET9300 Project Handler :(#if ESC_32BIT_ACCESS) lines 1810 to 1818 deleted*/
                HW_EscReadWord(nControl, ESC_EEPROM_CONTROL_OFFSET);

/*ET9300 Project Handler :(#if BIG_ENDIAN_FORMAT) lines 1821 to 1823 deleted*/
            }
            while ( nControl & (ESC_EEPROM_BUSY_MASK));

            /* we have to check if the access was without errors */
/*ET9300 Project Handler :(#if ESC_32BIT_ACCESS) lines 1829 to 1845 deleted*/
            HW_EscReadWord(nControl, ESC_EEPROM_CONTROL_OFFSET);

/*ET9300 Project Handler :(#if BIG_ENDIAN_FORMAT) lines 1848 to 1850 deleted*/
...
/*ET9300 Project Handler :(#if ESC_32BIT_ACCESS) lines 1879 to 1881 deleted*/
            if(!(nControl & ESC_EEPROM_ERROR_MASK))
            {
...
/*ECATCHANGE_END(V5.13) ECAT4*/
                    UINT32 u16CurTimer = 0;
                    UINT32 u16LastTimer = HAL_GetTick();
                    UINT32 Delta = 0;
...
/*ET9300 Project Handler :(#if ESC_32BIT_ACCESS) lines 1939 to 1943 deleted*/
    nConfig = 0;
