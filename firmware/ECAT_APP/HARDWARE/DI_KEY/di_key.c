...
void DI_Init(void)
{
  ...
  GPIO_Init(GPIOD, &GPIO_InitStructure);
	...
	/* ST_IN_17: PG5;  ST_IN_18: PG3;  ST_IN_19: PG2; */
  ...
  GPIO_Init(GPIOG, &GPIO_InitStructure);
	...
	/* ST_IN_20: PD15; ST_IN_21: PD13;  ST_IN_22: PD12; ST_IN_23: PD11; ST_IN_24: PD14; */
...
void DI_process_data(TOBJ6000 *IN_GENERIC)
{
  ...
  IN_GENERIC->Digital_Inputs_channel1=~input_filter(ST_IN1_I0_3,(uint16_t *)&a0,6,2,(BOOL *)&b0);
	IN_GENERIC->Digital_Inputs_channel2=~input_filter(ST_IN2_I0_2,(uint16_t *)&a1,6,2,(BOOL *)&b1);
	IN_GENERIC->Digital_Inputs_channel3=~input_filter(ST_IN3_I0_1,(uint16_t *)&a2,6,2,(BOOL *)&b2);
	IN_GENERIC->Digital_Inputs_channel4=~input_filter(ST_IN4_I0_0,(uint16_t *)&a3,6,2,(BOOL *)&b3);
...
#ifdef hardware_test
	test_di[0] = ST_IN1_I0_3;
	test_di[1] = ST_IN2_I0_2;
	test_di[2] = ST_IN3_I0_1;
	test_di[3] = ST_IN4_I0_0;
	test_di[4] = ST_IN5_I1_0;
	test_di[5] = ST_IN6_I1_1;
	test_di[6] = ST_IN7_I1_2;
	test_di[7] = ST_IN8_I1_3;
	test_di[8] = ST_IN17_I2_0;
	test_di[9] = ST_IN18_I2_1;
	test_di[10] = ST_IN19_I2_2;
	test_di[11] = ST_IN20_I2_3;
	test_di[12] = ST_IN21_I3_3;
	test_di[13] = ST_IN22_I3_2;
	test_di[14] = ST_IN23_I3_1;
	test_di[15] = ST_IN24_I3_0;
#endif	
