#ifndef __BOOT_INITIAL_H		//Boot_Initial
#define __BOOT_INITIAL_H
...
static u16 crc_table[256] = { 0x0000, 0x1021, 0x2042, 0x3063, 0x4084, 0x50a5,
...
uint16_t GetCRC16(uint8_t *ptr, uint8_t len);			//CRC校验函数
...
float Change_4x8_to_fdata(uint8_t *pdata);
void Change_4x8_DCBA_ABCD(uint8_t *data0, uint8_t *data1);
