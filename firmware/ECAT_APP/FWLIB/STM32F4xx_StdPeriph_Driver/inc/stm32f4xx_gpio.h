...
#define GPIO_Pin_11_14             ((uint16_t)0x7800)  /* All pins selected */

#define GPIO_Pin_11_15             ((uint16_t)0xF800)  /* All pins selected */
#define GPIO_Pin_8_14              ((uint16_t)0x7F00)  /* All pins selected */
#define GPIO_Pin_7_14              ((uint16_t)0x7F80)  /* All pins selected */
